...
public class BannerPatternTagGenerator extends TagsProvider<BannerPattern> {
   ...
   public BannerPatternTagGenerator(PackOutput output, CompletableFuture<Provider> provider, @Nullable ExistingFileHelper existingFileHelper) {
      super(output, Registries.f_256969_, provider, "iceandfire", existingFileHelper);
   }

   protected void m_6577_(Provider pProvider) {
      this.m_206424_(FIRE_BANNER_PATTERN).m_255204_(IafBannerPatterns.PATTERN_FIRE.getKey());
      this.m_206424_(ICE_BANNER_PATTERN).m_255204_(IafBannerPatterns.PATTERN_ICE.getKey());
      this.m_206424_(LIGHTNING_BANNER_PATTERN).m_255204_(IafBannerPatterns.PATTERN_LIGHTNING.getKey());
      this.m_206424_(FIRE_HEAD_BANNER_PATTERN).m_255204_(IafBannerPatterns.PATTERN_FIRE_HEAD.getKey());
      this.m_206424_(ICE_HEAD_BANNER_PATTERN).m_255204_(IafBannerPatterns.PATTERN_ICE_HEAD.getKey());
      this.m_206424_(LIGHTNING_HEAD_BANNER_PATTERN).m_255204_(IafBannerPatterns.PATTERN_LIGHTNING_HEAD.getKey());
      this.m_206424_(AMPHITHERE_BANNER_PATTERN).m_255204_(IafBannerPatterns.PATTERN_AMPHITHERE.getKey());
      this.m_206424_(BIRD_BANNER_PATTERN).m_255204_(IafBannerPatterns.PATTERN_BIRD.getKey());
      this.m_206424_(EYE_BANNER_PATTERN).m_255204_(IafBannerPatterns.PATTERN_EYE.getKey());
      this.m_206424_(FAE_BANNER_PATTERN).m_255204_(IafBannerPatterns.PATTERN_FAE.getKey());
      this.m_206424_(FEATHER_BANNER_PATTERN).m_255204_(IafBannerPatterns.PATTERN_FEATHER.getKey());
      this.m_206424_(GORGON_BANNER_PATTERN).m_255204_(IafBannerPatterns.PATTERN_GORGON.getKey());
      this.m_206424_(HIPPOCAMPUS_BANNER_PATTERN).m_255204_(IafBannerPatterns.PATTERN_HIPPOCAMPUS.getKey());
      this.m_206424_(HIPPOGRYPH_HEAD_BANNER_PATTERN).m_255204_(IafBannerPatterns.PATTERN_HIPPOGRYPH_HEAD.getKey());
      this.m_206424_(MERMAID_BANNER_PATTERN).m_255204_(IafBannerPatterns.PATTERN_MERMAID.getKey());
      this.m_206424_(SEA_SERPENT_BANNER_PATTERN).m_255204_(IafBannerPatterns.PATTERN_SEA_SERPENT.getKey());
      this.m_206424_(TROLL_BANNER_PATTERN).m_255204_(IafBannerPatterns.PATTERN_TROLL.getKey());
      this.m_206424_(WEEZER_BANNER_PATTERN).m_255204_(IafBannerPatterns.PATTERN_WEEZER.getKey());
      this.m_206424_(DREAD_BANNER_PATTERN).m_255204_(IafBannerPatterns.PATTERN_DREAD.getKey());
   }

   private static TagKey<BannerPattern> create(String name) {
      return TagKey.m_203882_(Registries.f_256969_, new ResourceLocation("iceandfire", name));
   }
