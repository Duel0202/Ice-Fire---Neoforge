...
public class IafProcessorLists {
   ...
   private static ResourceKey<StructureProcessorList> createKey(String name) {
      return ResourceKey.m_135785_(Registries.f_257011_, new ResourceLocation("iceandfire", name));
   }
   ...
   private static void register(BootstapContext<StructureProcessorList> pContext, ResourceKey<StructureProcessorList> pKey, List<StructureProcessor> pProcessors) {
      pContext.m_255272_(pKey, new StructureProcessorList(pProcessors));
   }
   ...
   public static void bootstrap(BootstapContext<StructureProcessorList> pContext) {
      ...
      RuleProcessor mossify = new RuleProcessor(ImmutableList.of(new ProcessorRule(new RandomBlockMatchTest(Blocks.f_50652_, 0.1F), AlwaysTrueTest.f_73954_, Blocks.f_50079_.m_49966_())));
