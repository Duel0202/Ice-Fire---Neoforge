...
public class ItemAmphithereArrow extends ArrowItem {
   ...
   public AbstractArrow m_6394_(@NotNull Level worldIn, @NotNull ItemStack stack, @NotNull LivingEntity shooter) {
      return new EntityAmphithereArrow((EntityType)IafEntityRegistry.AMPHITHERE_ARROW.get(), shooter, worldIn);
   }

   public void m_7373_(@NotNull ItemStack stack, @Nullable Level worldIn, List<Component> tooltip, @NotNull TooltipFlag flagIn) {
      tooltip.add(Component.m_237115_("item.iceandfire.amphithere_arrow.desc").m_130940_(ChatFormatting.GRAY));
   }
}
