...
public class ItemHydraArrow extends ArrowItem {
   ...
   public AbstractArrow m_6394_(@NotNull Level worldIn, @NotNull ItemStack stack, @NotNull LivingEntity shooter) {
      return new EntityHydraArrow((EntityType)IafEntityRegistry.HYDRA_ARROW.get(), worldIn, shooter);
   }

   public void m_7373_(@NotNull ItemStack stack, @Nullable Level worldIn, List<Component> tooltip, @NotNull TooltipFlag flagIn) {
      tooltip.add(Component.m_237115_("item.iceandfire.hydra_arrow.desc").m_130940_(ChatFormatting.GRAY));
   }
}
