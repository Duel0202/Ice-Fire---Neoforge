...
public class MausoleumStructure extends IafStructure {
   ...
   public MausoleumStructure(StructureSettings config, Holder<StructureTemplatePool> startPool, Optional<ResourceLocation> startJigsawName, int size, HeightProvider startHeight, Optional<Types> projectStartToHeightmap, int maxDistanceFromCenter) {
   ...
   public static MausoleumStructure buildStructureConfig(BootstapContext<Structure> context) {
      ...
      Holder<StructureTemplatePool> graveyardHolder = templatePoolHolderGetter.m_255043_(IafStructurePieces.MAUSOLEUM_START);
      return new MausoleumStructure(new StructureSettings(context.m_255420_(Registries.f_256952_).m_254956_(IafBiomeTagGenerator.HAS_MAUSOLEUM), new HashMap(), Decoration.SURFACE_STRUCTURES, TerrainAdjustment.BEARD_THIN), graveyardHolder, Optional.empty(), 1, ConstantHeight.f_161945_, Optional.of(Types.WORLD_SURFACE_WG), 16);
   }
}
