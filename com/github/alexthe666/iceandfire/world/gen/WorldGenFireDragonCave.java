...
public class WorldGenFireDragonCave extends WorldGenDragonCave {
   ...
   public WorldGenFireDragonCave(Codec<NoneFeatureConfiguration> configuration) {
      ...
      this.CEILING_DECO = new WorldGenCaveStalactites((Block)IafBlockRegistry.CHARRED_STONE.get(), 3);
      this.PALETTE_BLOCK1 = ((Block)IafBlockRegistry.CHARRED_STONE.get()).m_49966_();
      this.PALETTE_BLOCK2 = ((Block)IafBlockRegistry.CHARRED_COBBLESTONE.get()).m_49966_();
      this.TREASURE_PILE = ((Block)IafBlockRegistry.GOLD_PILE.get()).m_49966_();
