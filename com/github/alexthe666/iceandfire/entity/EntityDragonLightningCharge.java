...
public class EntityDragonLightningCharge extends EntityDragonCharge implements IDragonProjectile {
   ...
   public EntityDragonLightningCharge(SpawnEntity spawnEntity, Level worldIn) {
      this((EntityType)IafEntityRegistry.LIGHTNING_DRAGON_CHARGE.get(), worldIn);
   }

   public EntityDragonLightningCharge(EntityType<? extends Fireball> type, Level worldIn, double posX, double posY, double posZ, double accelX, double accelY, double accelZ) {
      super(type, worldIn, posX, posY, posZ, accelX, accelY, accelZ);
   }

   public EntityDragonLightningCharge(EntityType<? extends Fireball> type, Level worldIn, EntityDragonBase shooter, double accelX, double accelY, double accelZ) {
