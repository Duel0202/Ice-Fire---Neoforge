...
public final class IafSoundRegistry {
   ...
   private static SoundEvent createSoundEvent(String soundName) {
      ResourceLocation soundID = new ResourceLocation("iceandfire", soundName);
      return SoundEvent.m_262824_(soundID);
   }

   @SubscribeEvent
   public static void registerSoundEvents(NewRegistryEvent event) {
      try {
         Field[] var1 = IafSoundRegistry.class.getFields();
         ...
         for(int var3 = 0; var3 < var2; ++var3) {
            ...
            if (obj instanceof SoundEvent) {
               ForgeRegistries.SOUND_EVENTS.register(((SoundEvent)obj).m_11660_(), (SoundEvent)obj);
