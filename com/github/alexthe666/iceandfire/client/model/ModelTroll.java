...
public class ModelTroll extends ModelDragonBase<EntityTroll> {
   ...
   public ModelTroll() {
      ...
      this.setRotateAngle(this.hornL, -0.59184116F, 2.6406832F, -0.17453292F);
      ...
      this.setRotateAngle(this.leftleg2, 0.34906584F, 0.0F, 0.08726646F);
      ...
      this.setRotateAngle(this.hornR, -0.7740535F, -2.959555F, 0.27314404F);
      ...
      this.setRotateAngle(this.log1, -1.5934856F, 0.0F, 0.0F);
      ...
      this.setRotateAngle(this.nose2, -1.2747885F, 0.0F, 0.0F);
      ...
      this.setRotateAngle(this.hornR2, 1.2747885F, 0.0F, 0.0F);
      ...
      this.setRotateAngle(this.leftleg, -0.2617994F, 0.0F, -0.08726646F);
      ...
      this.setRotateAngle(this.upperBody, 0.31869712F, 0.0F, 0.0F);
      ...
      this.setRotateAngle(this.rightleg2, 0.34906584F, 0.0F, -0.08726646F);
      ...
      this.setRotateAngle(this.leftarm, -0.13665928F, 0.0F, -0.17453292F);
      ...
      this.setRotateAngle(this.mouth, -0.18203785F, 0.0F, 0.0F);
      ...
      this.setRotateAngle(this.hornL2, 1.4114478F, 0.0F, 0.0F);
      ...
      this.setRotateAngle(this.rightleg, -0.2617994F, 0.0F, 0.08726646F);
      ...
      this.setRotateAngle(this.column, -0.045553092F, 0.0F, 0.0F);
      ...
      this.setRotateAngle(this.leftarm2, -0.31869712F, 0.0F, 0.0F);
      ...
      this.setRotateAngle(this.rightarm, -0.045553092F, 0.27314404F, 0.0F);
      ...
      this.setRotateAngle(this.handle, -0.045553092F, 0.0F, 0.0F);
      ...
      this.setRotateAngle(this.nose, -0.5462881F, 0.0F, 0.0F);
      ...
      this.setRotateAngle(this.chest, -0.22759093F, 0.0F, 0.0F);
      ...
      this.setRotateAngle(this.rightarm2, -2.1399481F, 0.22759093F, -0.13665928F);
   ...
   public void animate(IAnimatedEntity entity, float f, float f1, float f2, float f3, float f4, float f5) {
      ...
      if (this.animator.setAnimation(EntityTroll.ANIMATION_SPEAK)) {
         ...
         this.rotate(this.animator, this.jaw, 25.0F, 0.0F, 0.0F);
      ...
      if (this.animator.setAnimation(EntityTroll.ANIMATION_ROAR)) {
         this.animator.startKeyframe(5);
         this.rotateMinus(this.animator, this.leftleg, -31.0F, -26.0F, -5.0F);
         this.rotateMinus(this.animator, this.rightleg, -31.0F, 26.0F, 5.0F);
         this.rotate(this.animator, this.upperBody, 18.0F, 0.0F, 5.0F);
         this.rotateMinus(this.animator, this.leftleg2, 41.0F, 0.0F, 5.0F);
         this.rotateMinus(this.animator, this.rightleg2, 41.0F, 0.0F, -5.0F);
         this.rotateMinus(this.animator, this.leftarm, -26.0F, -44.0F, -2.0F);
         this.rotateMinus(this.animator, this.leftarm2, -60.0F, 0.0F, 0.0F);
         this.rotateMinus(this.animator, this.rightarm, -39.0F, 57.0F, 0.0F);
         this.rotateMinus(this.animator, this.rightarm2, -73.0F, 13.0F, -7.0F);
         this.rotate(this.animator, this.head, -57.0F, 0.0F, 0.0F);
         this.rotate(this.animator, this.jaw, 60.0F, 0.0F, 0.0F);
         ...
         this.rotateMinus(this.animator, this.rightarm, -39.0F, 57.0F, 0.0F);
         this.rotateMinus(this.animator, this.rightarm2, -73.0F, 13.0F, -7.0F);
         this.rotate(this.animator, this.head, -57.0F, -28.0F, 0.0F);
         this.rotate(this.animator, this.jaw, 60.0F, 0.0F, 0.0F);
         this.animator.move(this.body, 0.0F, 2.0F, 0.0F);
         this.animator.endKeyframe();
         this.animator.startKeyframe(5);
      ...
      if (this.animator.setAnimation(EntityTroll.ANIMATION_STRIKE_HORIZONTAL)) {
         ...
         this.rotate(this.animator, this.body, 0.0F, 31.0F, 0.0F);
         this.rotate(this.animator, this.upperBody, 18.0F, 39.0F, 0.0F);
         this.rotate(this.animator, this.leftarm, 18.0F, 0.0F, -10.0F);
         this.rotate(this.animator, this.rightarm, 41.0F, 57.0F, 65.0F);
         this.rotate(this.animator, this.rightarm2, 50.0F, 0.0F, 0.0F);
         this.rotate(this.animator, this.rightleg, -15.0F, 57.0F, 5.0F);
         this.rotate(this.animator, this.leftleg, -13.0F, -44.0F, -5.0F);
         ...
         this.rotate(this.animator, this.upperBody, 18.0F, -39.0F, 0.0F);
         this.rotate(this.animator, this.leftarm, 18.0F, 0.0F, -10.0F);
         this.rotate(this.animator, this.rightarm, -60.0F, -40.0F, -35.0F);
         this.rotate(this.animator, this.rightarm2, 80.0F, -45.0F, 40.0F);
         this.rotate(this.animator, this.rightleg, -15.0F, 57.0F, 5.0F);
         this.rotate(this.animator, this.leftleg, -13.0F, -44.0F, -5.0F);
         this.rotate(this.animator, this.log1, 15.0F, 0.0F, 0.0F);
         this.animator.move(this.body, 0.0F, 3.0F, 0.0F);
         this.animator.endKeyframe();
      ...
      if (this.animator.setAnimation(EntityTroll.ANIMATION_STRIKE_VERTICAL)) {
         ...
         this.rotate(this.animator, this.upperBody, -30.0F, 0.0F, 0.0F);
         this.rotate(this.animator, this.rightleg, -15.0F, 57.0F, 5.0F);
         this.rotate(this.animator, this.leftleg, -13.0F, -44.0F, -5.0F);
         this.rotate(this.animator, this.leftarm, -203.0F, 35.0F, -15.0F);
         this.rotate(this.animator, this.rightarm, -212.0F, -40.0F, 25.0F);
         this.rotate(this.animator, this.leftarm2, 18.0F, 0.0F, 0.0F);
         this.rotate(this.animator, this.rightarm2, 122.0F, -13.0F, 7.0F);
         this.rotate(this.animator, this.log1, 0.0F, -40.0F, 0.0F);
         this.animator.move(this.body, 0.0F, 3.0F, 0.0F);
         this.animator.move(this.log1, 5.0F, 0.0F, 0.0F);
         this.animator.endKeyframe();
         this.animator.startKeyframe(5);
         this.rotate(this.animator, this.body, 5.0F, 0.0F, 0.0F);
         this.rotate(this.animator, this.upperBody, 35.0F, 0.0F, 0.0F);
         this.rotate(this.animator, this.rightleg, -15.0F, 57.0F, 5.0F);
         this.rotate(this.animator, this.leftleg, -13.0F, -44.0F, -5.0F);
         this.rotate(this.animator, this.leftarm, -103.0F, 20.0F, -15.0F);
         this.rotate(this.animator, this.rightarm, -112.0F, -20.0F, 25.0F);
         this.rotate(this.animator, this.leftarm2, 18.0F, 0.0F, 0.0F);
         this.rotate(this.animator, this.rightarm2, 122.0F, -13.0F, 7.0F);
         this.rotate(this.animator, this.log1, 90.0F, 25.0F, 20.0F);
         this.animator.move(this.body, 0.0F, 3.0F, 0.0F);
   ...
   public void setupAnim(EntityTroll entity, float limbSwing, float limbSwingAmount, float ageInTicks, float f3, float f4) {
      this.resetToDefaultPose();
      this.log1.showModel = true;
      this.animate(entity, limbSwing, limbSwingAmount, ageInTicks, f3, f4, 1.0F);
      this.progressRotation(this.head, entity.stoneProgress, (float)Math.toRadians(-31.0D), 0.0F, 0.0F);
      this.progressRotation(this.jaw, entity.stoneProgress, (float)Math.toRadians(54.0D), 0.0F, 0.0F);
      this.progressRotation(this.leftarm, entity.stoneProgress, (float)Math.toRadians(10.0D), (float)Math.toRadians(-73.0D), (float)Math.toRadians(-60.0D));
      this.progressRotation(this.leftarm2, entity.stoneProgress, (float)Math.toRadians(-80.0D), 0.0F, 0.0F);
      this.progressRotation(this.rightarm, entity.stoneProgress, (float)Math.toRadians(-101.0D), (float)Math.toRadians(70.0D), 0.0F);
      this.progressRotation(this.rightarm2, entity.stoneProgress, (float)Math.toRadians(-40.0D), 0.0F, 0.0F);
      float speed_walk = 0.2F;
      float speed_idle = 0.05F;
      float degree_walk = 0.75F;
      float degree_idle = 0.5F;
      this.walk(this.rightleg, speed_walk, degree_walk * -0.75F, true, 0.0F, 0.0F, limbSwing, limbSwingAmount);
      this.walk(this.leftleg, speed_walk, degree_walk * -0.75F, false, 0.0F, 0.0F, limbSwing, limbSwingAmount);
      this.walk(this.rightleg2, speed_walk, degree_walk * -0.5F, true, 1.0F, -0.3F, limbSwing, limbSwingAmount);
      this.walk(this.leftleg2, speed_walk, degree_walk * -0.5F, false, 1.0F, 0.3F, limbSwing, limbSwingAmount);
      this.walk(this.leftarm, speed_walk, degree_walk * -0.75F, true, 0.0F, 0.0F, limbSwing, limbSwingAmount);
      this.walk(this.leftarm2, speed_walk, degree_walk * -0.5F, true, 1.0F, 0.3F, limbSwing, limbSwingAmount);
      this.swing(this.body, speed_walk, degree_walk * -0.5F, false, 0.0F, 0.0F, limbSwing, limbSwingAmount);
      this.swing(this.upperBody, speed_walk, degree_walk * -0.25F, true, 0.0F, 0.0F, limbSwing, limbSwingAmount);
      this.walk(this.rightarm, speed_walk, degree_walk * -0.25F, false, 0.0F, 0.0F, limbSwing, limbSwingAmount);
      this.walk(this.rightarm2, speed_walk, degree_walk * -0.125F, false, 1.0F, -0.3F, limbSwing, limbSwingAmount);
      this.walk(this.body, speed_idle, degree_idle * -0.1F, true, 0.0F, -0.1F, ageInTicks, 1.0F);
      this.walk(this.rightleg, speed_idle, degree_idle * 0.1F, true, 0.0F, 0.1F, ageInTicks, 1.0F);
      this.walk(this.leftleg, speed_idle, degree_idle * 0.1F, true, 0.0F, 0.1F, ageInTicks, 1.0F);
      this.walk(this.jaw, speed_idle, degree_idle * -0.15F, true, 0.0F, -0.1F, ageInTicks, 1.0F);
      this.walk(this.mouth, speed_idle, degree_idle * -0.15F, false, 0.0F, -0.1F, ageInTicks, 1.0F);
      this.faceTarget(f3, f4, 1.0F, new AdvancedModelBox[]{this.head});
   }

   public void animateStatue(EntityTroll troll) {
      this.progressRotation(this.head, 20.0F, (float)Math.toRadians(-31.0D), 0.0F, 0.0F);
      this.progressRotation(this.jaw, 20.0F, (float)Math.toRadians(54.0D), 0.0F, 0.0F);
      this.progressRotation(this.leftarm, 20.0F, (float)Math.toRadians(10.0D), (float)Math.toRadians(-73.0D), (float)Math.toRadians(-60.0D));
      this.progressRotation(this.leftarm2, 20.0F, (float)Math.toRadians(-80.0D), 0.0F, 0.0F);
      this.progressRotation(this.rightarm, 20.0F, (float)Math.toRadians(-101.0D), (float)Math.toRadians(70.0D), 0.0F);
      this.progressRotation(this.rightarm2, 20.0F, (float)Math.toRadians(-40.0D), 0.0F, 0.0F);
   }
