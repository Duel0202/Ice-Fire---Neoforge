...
public class ModelHippocampus extends ModelDragonBase<EntityHippocampus> {
   ...
   public ModelHippocampus() {
      ...
      this.setRotateAngle(this.FrontLegL, 0.62831855F, 0.0F, 0.0F);
      ...
      this.setRotateAngle(this.FinRBack, -0.5235988F, -0.17453292F, 0.17453292F);
      ...
      this.setRotateAngle(this.ChestL, 0.0F, 1.5707964F, 0.0F);
      ...
      this.setRotateAngle(this.FinLBack, -0.5235988F, 0.17453292F, -0.17453292F);
      ...
      this.setRotateAngle(this.FrontLegR, 0.62831855F, 0.0F, 0.0F);
      ...
      this.setRotateAngle(this.ChestR, 0.0F, 1.5707964F, 0.0F);
   ...
   public void setupAnim(EntityHippocampus entity, float f, float f1, float f2, float f3, float f4) {
      ...
      this.progressRotation(this.Body, entity.onLandProgress, (float)Math.toRadians(-5.0D), 0.0F, 0.0F);
      this.progressRotation(this.FrontThighL, Math.max(0.0F, entity.onLandProgress), 0.0F, 0.0F, (float)Math.toRadians(-65.0D));
      this.progressRotation(this.FrontThighR, Math.max(0.0F, entity.onLandProgress), 0.0F, 0.0F, (float)Math.toRadians(65.0D));
      this.progressPosition(this.Body, entity.onLandProgress, 0.0F, 20.0F, 0.0F);
      this.progressRotation(this.Body, entity.sitProgress, (float)Math.toRadians(-5.0D), 0.0F, 0.0F);
      this.progressRotation(this.Tail_1, entity.sitProgress, (float)Math.toRadians(55.0D), 0.0F, 0.0F);
      this.progressRotation(this.Tail_2, entity.sitProgress, (float)Math.toRadians(-26.0D), 0.0F, 0.0F);
      this.progressRotation(this.Tail_3, entity.sitProgress, (float)Math.toRadians(-33.0D), 0.0F, 0.0F);
      this.progressRotation(this.FlukeR, Math.max(0.0F, entity.sitProgress), (float)Math.toRadians(-50.0D), (float)Math.toRadians(5.0D), (float)Math.toRadians(30.0D));
      this.progressRotation(this.FlukeL, Math.max(0.0F, entity.sitProgress), (float)Math.toRadians(-50.0D), (float)Math.toRadians(-5.0D), (float)Math.toRadians(-30.0D));
      this.progressRotation(this.Body, entity.sitProgress * entity.onLandProgress * 0.05F, (float)Math.toRadians(-5.0D), (float)Math.toRadians(-5.0D), (float)Math.toRadians(85.0D));
      ...
      if (entity.m_20096_() && !entity.m_20069_()) {
         this.progressRotation(this.FrontThighL, Math.max(0.0F, entity.sitProgress), 0.0F, 0.0F, (float)Math.toRadians(60.0D));
         this.progressRotation(this.FrontThighR, Math.max(0.0F, entity.sitProgress), 0.0F, 0.0F, (float)Math.toRadians(-60.0D));
      }

      this.progressRotation(this.Tail_2, entity.sitProgress * entity.onLandProgress * 0.05F, (float)Math.toRadians(-7.0D), (float)Math.toRadians(-25.0D), (float)Math.toRadians(1.0D));
      this.progressRotation(this.Tail_3, entity.sitProgress * entity.onLandProgress * 0.05F, (float)Math.toRadians(20.0D), (float)Math.toRadians(-36.0D), (float)Math.toRadians(36.0D));
