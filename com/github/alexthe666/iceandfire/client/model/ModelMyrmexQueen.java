...
public class ModelMyrmexQueen extends ModelMyrmexBase {
   ...
   public ModelMyrmexQueen() {
      ...
      this.setRotateAngle(this.crest1, 0.4098033F, -0.17453292F, -0.27925268F);
      ...
      this.setRotateAngle(this.crest2, 0.4098033F, 0.17453292F, 0.27925268F);
   ...
   public void animate(IAnimatedEntity entity, float f, float f1, float f2, float f3, float f4, float f5) {
      ...
      if (myrmexQueen.getAnimation() == EntityMyrmexQueen.ANIMATION_EGG) {
         int animationTick = Mth.m_14045_(myrmexQueen.getAnimationTick(), 0, 20);
         float swellToPi = (float)((double)((float)animationTick / 20.0F) * 3.141592653589793D);
         this.increaseScale(this.Body5, 0.5F * Math.abs(Mth.m_14031_(swellToPi + 0.5F)));
         this.increaseScale(this.Tail1, 0.75F * Math.abs(Mth.m_14031_(swellToPi)));
         this.increaseScale(this.Tail2, 0.75F * Math.abs(Mth.m_14031_(swellToPi - 0.5F)));
         this.increaseScale(this.Tail3, 0.75F * Math.abs(Mth.m_14031_(swellToPi - 1.0F)));
         AdvancedModelBox var10000 = this.Stinger;
         var10000.rotationPointZ += 10.0F * Math.abs(Mth.m_14031_(swellToPi - 1.0F));
      }
   ...
   public void m_6973_(Entity entity, float f, float f1, float f2, float f3, float f4) {
      ...
      float gasterSwell1 = -0.05F + 0.2F * Math.abs(Mth.m_14031_((float)entity.f_19797_ * 0.15F + 1.0F));
      float gasterSwell2 = -0.05F + 0.2F * Math.abs(Mth.m_14031_((float)entity.f_19797_ * 0.15F + 0.5F));
      float gasterSwell3 = -0.05F + 0.2F * Math.abs(Mth.m_14031_((float)entity.f_19797_ * 0.15F));
      EntityMyrmexQueen myrmexQueen = (EntityMyrmexQueen)entity;
      if (myrmexQueen.getAnimation() != EntityMyrmexQueen.ANIMATION_EGG) {
         ...
         AdvancedModelBox var10000 = this.Stinger;
         var10000.rotationPointZ += 20.0F * gasterSwell3;
      }
      ...
      this.chainWave(GASTER, speed_idle, degree_idle * 0.15F, 0.0D, f2, 1.0F);
