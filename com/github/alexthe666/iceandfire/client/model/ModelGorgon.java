...
public class ModelGorgon extends ModelDragonBase<EntityGorgon> {
   ...
   public ModelGorgon() {
      ...
      this.setRotateAngle(this.SnakeHeadR2, 0.7749262F, -0.0F, -0.17453292F);
      ...
      this.setRotateAngle(this.SnakeBodyL5, 0.6981317F, 1.0471976F, 0.27925268F);
      ...
      this.setRotateAngle(this.SnakeBodyR5, 0.6981317F, -1.0471976F, -0.27925268F);
      ...
      this.setRotateAngle(this.SnakeBaseR4, -2.1282544F, 0.0F, -0.2617994F);
      ...
      this.setRotateAngle(this.SnakeHeadL2, 0.7749262F, -0.0F, 0.17453292F);
      ...
      this.setRotateAngle(this.SnakeBaseL2, -1.5707964F, 0.0F, 2.268928F);
      ...
      this.setRotateAngle(this.SnakeBaseR7, -1.5707964F, 0.0F, -2.2734659F);
      ...
      this.setRotateAngle(this.SnakeHeadR3, 0.69429195F, -0.06981317F, 0.15707964F);
      ...
      this.setRotateAngle(this.SnakeBaseL7, -1.5707964F, 0.0F, 2.2734659F);
      ...
      this.setRotateAngle(this.SnakeBaseL4, -2.1282544F, 0.0F, 0.2617994F);
      ...
      this.setRotateAngle(this.SnakeHeadL3, 0.69429195F, 0.06981317F, 0.15707964F);
      ...
      this.setRotateAngle(this.SnakeBaseR2, -1.5707964F, 0.0F, -2.268928F);
   ...
   public void setupAnim(EntityGorgon entity, float f, float f1, float f2, float f3, float f4) {
      ...
      this.chainFlap(TAIL, speed_walk, degree_walk * 0.75F, -3.0D, f, f1);
      ...
      this.Right_Arm.rotateAngleX = Mth.m_14089_(f * 0.6662F + 3.1415927F) * 2.0F * f1 * 0.5F;
      this.Left_Arm.rotateAngleX = Mth.m_14089_(f * 0.6662F) * 2.0F * f1 * 0.5F;
      ...
      f12 = 0.0F;
      this.chainFlap(SNAKEL1, speed_idle, degree_idle * 0.75F, -3.0D, f2, 1.0F);
      this.chainSwing(SNAKEL1, speed_idle, degree_idle * 0.75F, -3.0D, f2, 1.0F);
      this.chainFlap(SNAKEL2, speed_idle, degree_idle * 0.75F, -3.0D, f2, 1.0F);
      this.chainSwing(SNAKEL2, speed_idle, degree_idle * 0.75F, -3.0D, f2, 1.0F);
      this.chainFlap(SNAKEL3, speed_idle, degree_idle * 0.75F, -3.0D, f2, 1.0F);
      this.chainSwing(SNAKEL3, speed_idle, degree_idle * 0.75F, -3.0D, f2, 1.0F);
      this.chainFlap(SNAKEL4, speed_idle, degree_idle * 0.75F, -3.0D, f2, 1.0F);
      this.chainSwing(SNAKEL4, speed_idle, degree_idle * 0.75F, -3.0D, f2, 1.0F);
      this.chainFlap(SNAKER1, speed_idle, degree_idle * 0.75F, -3.0D, f2, 1.0F);
      this.chainSwing(SNAKER1, speed_idle, degree_idle * 0.75F, -3.0D, f2, 1.0F);
      this.chainFlap(SNAKER2, speed_idle, degree_idle * 0.75F, -3.0D, f2, 1.0F);
      this.chainSwing(SNAKER2, speed_idle, degree_idle * 0.75F, -3.0D, f2, 1.0F);
      this.chainFlap(SNAKER3, speed_idle, degree_idle * 0.75F, -3.0D, f2, 1.0F);
      this.chainSwing(SNAKER3, speed_idle, degree_idle * 0.75F, -3.0D, f2, 1.0F);
      this.chainFlap(SNAKER4, speed_idle, degree_idle * 0.75F, -3.0D, f2, 1.0F);
      this.chainSwing(SNAKER4, speed_idle, degree_idle * 0.75F, -3.0D, f2, 1.0F);
      this.chainFlap(SNAKER5, speed_idle, degree_idle * 0.75F, -3.0D, f2, 1.0F);
      this.chainSwing(SNAKER5, speed_idle, degree_idle * 0.75F, -3.0D, f2, 1.0F);
      this.chainFlap(SNAKER6, speed_idle, degree_idle * 0.75F, -3.0D, f2, 1.0F);
      this.chainSwing(SNAKER6, speed_idle, degree_idle * 0.75F, -3.0D, f2, 1.0F);
      this.chainFlap(SNAKER7, speed_idle, degree_idle * 0.75F, -3.0D, f2, 1.0F);
      this.chainSwing(SNAKER7, speed_idle, degree_idle * 0.75F, -3.0D, f2, 1.0F);
      this.chainFlap(SNAKEL5, speed_idle, degree_idle * 0.75F, -3.0D, f2, 1.0F);
      this.chainSwing(SNAKEL5, speed_idle, degree_idle * 0.75F, -3.0D, f2, 1.0F);
      this.chainFlap(SNAKEL6, speed_idle, degree_idle * 0.75F, -3.0D, f2, 1.0F);
      this.chainSwing(SNAKEL6, speed_idle, degree_idle * 0.75F, -3.0D, f2, 1.0F);
      this.chainFlap(SNAKEL7, speed_idle, degree_idle * 0.75F, -3.0D, f2, 1.0F);
      this.chainSwing(SNAKEL7, speed_idle, degree_idle * 0.75F, -3.0D, f2, 1.0F);
      this.faceTarget(f3, f4, 1.0F, new AdvancedModelBox[]{this.Head});
      float deathProg = Math.min(40.0F, (float)entity.f_20919_) / 2.0F;
      this.progressRotation(this.Tail_1, deathProg, (float)Math.toRadians(5.0D), (float)Math.toRadians(57.0D), 0.0F);
      this.progressPosition(this.Tail_1, deathProg, -5.0F, 22.0F, -4.0F);
      this.progressRotation(this.Tail_2, deathProg, (float)Math.toRadians(18.0D), (float)Math.toRadians(-54.0D), 0.0F);
      this.progressRotation(this.Body, deathProg, (float)Math.toRadians(-9.0D), (float)Math.toRadians(36.0D), 0.0F);
      this.progressRotation(this.Right_Arm, deathProg, 0.0F, 0.0F, (float)Math.toRadians(20.0D));
      this.progressRotation(this.Left_Arm, deathProg, 0.0F, 0.0F, (float)Math.toRadians(-20.0D));
