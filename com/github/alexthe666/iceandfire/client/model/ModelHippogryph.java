...
public class ModelHippogryph extends ModelDragonBase<EntityHippogryph> {
   ...
   public ModelHippogryph() {
      ...
      this.setRotateAngle(this.WingR2, 1.548107F, 0.0F, 0.17453292F);
      ...
      this.setRotateAngle(this.Quill_R, -1.1838568F, -0.17453292F, 0.0F);
      ...
      this.setRotateAngle(this.ToeR1_1, -1.821251F, 3.1415927F, 0.0F);
      ...
      this.setRotateAngle(this.ToeR1, -1.821251F, 3.1415927F, 0.0F);
      ...
      this.setRotateAngle(this.WingL, 0.12217305F, 0.38397244F, -0.6981317F);
      ...
      this.setRotateAngle(this.WingR, 0.12217305F, -0.38397244F, 0.6981317F);
      ...
      this.setRotateAngle(this.WingL2, 1.548107F, 0.0F, -0.17453292F);
      ...
      this.setRotateAngle(this.Quill_L, -1.1838568F, 0.17453292F, 0.0F);
   ...
   public void setupAnim(EntityHippogryph entity, float f, float f1, float f2, float f3, float f4) {
      ...
      float speed_walk = Math.max(entity.hoverProgress, entity.flyProgress);
      this.progressRotation(this.Beak, speed_walk, 0.0F, 0.0F, 0.0F);
      this.progressRotation(this.HindLegR, speed_walk, -0.17453292F, 0.0F, 0.0F);
      this.progressRotation(this.FingerR3, speed_walk, 0.40142572F, 0.0F, 0.0F);
      this.progressRotation(this.FingerL1, speed_walk, 0.034906585F, 0.0F, 0.0F);
      this.progressRotation(this.SaddleFront, speed_walk, 0.0F, 0.0F, 0.0F);
      this.progressRotation(this.Jaw, speed_walk, -0.045553092F, 0.0F, 0.0F);
      this.progressRotation(this.FingerL4, speed_walk, 0.6981317F, 0.0F, 0.0F);
      this.progressRotation(this.WingL, speed_walk, 0.08726646F, 0.0F, -1.3962634F);
      this.progressRotation(this.ToeR2_1, speed_walk, 0.4537856F, -0.4537856F, -0.4537856F);
      this.progressRotation(this.FingerR2, speed_walk, 0.2268928F, 0.0F, 0.0F);
      this.progressRotation(this.ToeR3_1, speed_walk, 0.4537856F, 0.0F, 0.0F);
      this.progressRotation(this.FingerR1, speed_walk, 0.034906585F, 0.0F, 0.0F);
      this.progressRotation(this.StirrupR, speed_walk, 0.0F, 0.0F, 0.0F);
      this.progressRotation(this.BackLegR1_1, speed_walk, 0.6981317F, 0.0F, 0.0F);
      this.progressRotation(this.Crest1, speed_walk, -2.4586453F, 0.0F, 0.0F);
      this.progressRotation(this.ChestL, speed_walk, 0.0F, 1.5707964F, 0.0F);
      this.progressRotation(this.Crest1_1, speed_walk, -2.2310543F, 0.0F, 0.0F);
      this.progressRotation(this.WingL3, speed_walk, 0.5235988F, 0.0F, 0.0F);
      this.progressRotation(this.BackLegR1, speed_walk, 0.6981317F, 0.0F, 0.0F);
      this.progressRotation(this.HindLegL, speed_walk, -0.17453292F, 0.0F, 0.0F);
      this.progressRotation(this.HindThighR, speed_walk, 0.7679449F, 0.0F, 0.0F);
      this.progressRotation(this.Body, speed_walk, 0.0F, 0.0F, 0.0F);
      this.progressRotation(this.Quill_R, speed_walk, -1.1838568F, -0.17453292F, 0.0F);
      this.progressRotation(this.Neck2, speed_walk, -0.59184116F, 0.0F, 0.0F);
      this.progressRotation(this.WingL21, speed_walk, 0.0F, 0.0F, 0.0F);
      this.progressRotation(this.ReinL, speed_walk, -0.04363323F, 0.0F, 0.0F);
      this.progressRotation(this.FingerL3, speed_walk, 0.40142572F, 0.0F, 0.0F);
      this.progressRotation(this.ToeR1, speed_walk, -0.7679449F, 3.1415927F, 0.0F);
      this.progressRotation(this.Saddleback, speed_walk, 0.0F, 0.0F, 0.0F);
      this.progressRotation(this.WingR2, speed_walk, -0.34906584F, 0.0F, 0.17453292F);
      this.progressRotation(this.ToeL4, speed_walk, 0.4537856F, 0.4537856F, 0.4537856F);
      this.progressRotation(this.WingL2, speed_walk, -0.34906584F, 0.0F, -0.17453292F);
      this.progressRotation(this.ReinR, speed_walk, -0.04363323F, 0.0F, 0.0F);
      this.progressRotation(this.ToeR3, speed_walk, 0.4537856F, 0.0F, 0.0F);
      this.progressRotation(this.FingerR4, speed_walk, 0.6981317F, 0.0F, 0.0F);
      this.progressRotation(this.Beak2, speed_walk, 0.0F, 0.0F, 0.0F);
      this.progressRotation(this.WingR, speed_walk, 0.08726646F, 0.0F, 1.3962634F);
      this.progressRotation(this.ChestR, speed_walk, 0.0F, 1.5707964F, 0.0F);
      this.progressRotation(this.ToeL4_1, speed_walk, 0.4537856F, 0.4537856F, 0.4537856F);
      this.progressRotation(this.Saddle, speed_walk, 0.0F, 0.0F, 0.0F);
      this.progressRotation(this.NoseBand, speed_walk, 0.091106184F, 0.0F, 0.0F);
      this.progressRotation(this.StirrupIronR, speed_walk, 0.0F, 0.0F, 0.0F);
      this.progressRotation(this.Tail3, speed_walk, 0.27314404F, 0.0F, 0.0F);
      this.progressRotation(this.FingerL2, speed_walk, 0.2268928F, 0.0F, 0.0F);
      this.progressRotation(this.WingR3, speed_walk, 0.5235988F, 0.0F, 0.0F);
      this.progressRotation(this.ToeR1_1, speed_walk, -0.7679449F, 3.1415927F, 0.0F);
      this.progressRotation(this.StirrupL, speed_walk, 0.0F, 0.0F, 0.0F);
      this.progressRotation(this.Tail1, speed_walk, -0.7285004F, 0.0F, 0.0F);
      this.progressRotation(this.BackLegR2_1, speed_walk, -1.3962634F, 0.0F, 0.0F);
      this.progressRotation(this.StirrupIronL, speed_walk, 0.0F, 0.0F, 0.0F);
      this.progressRotation(this.ToeR2, speed_walk, 0.4537856F, -0.4537856F, -0.4537856F);
      this.progressRotation(this.HindFootR, speed_walk, 0.0F, 0.0F, 0.0F);
      this.progressRotation(this.HindThighL, speed_walk, 0.7679449F, 0.0F, 0.0F);
      this.progressRotation(this.BackLegR2, speed_walk, -1.3962634F, 0.0F, 0.0F);
      this.progressRotation(this.WingR21, speed_walk, 0.0F, 0.0F, 0.0F);
      this.progressRotation(this.Neck, speed_walk, 1.1838568F, 0.0F, 0.0F);
      this.progressRotation(this.BeakTip, speed_walk, 0.0F, 0.0F, 0.0F);
      this.progressRotation(this.Tail2, speed_walk, 0.0F, 0.0F, 0.0F);
      this.progressRotation(this.HeadPivot, speed_walk, -0.13665928F, 0.0F, 0.0F);
      this.progressRotation(this.Quill_L, speed_walk, -1.1838568F, 0.17453292F, 0.0F);
      this.progressRotation(this.HindFootL, speed_walk, 0.0F, 0.0F, 0.0F);
      this.progressPositionPrev(this.HindThighL, speed_walk, 0.0F, -0.75F, 0.0F);
      this.progressPositionPrev(this.HindThighR, speed_walk, 0.0F, -0.75F, 0.0F);
      speed_walk = entity.sitProgress;
      this.progressRotation(this.HeadPivot, speed_walk, -0.13665928F, 0.0F, 0.0F);
      this.progressRotation(this.HindLegR, speed_walk, 1.548107F, 0.0F, 0.0F);
      this.progressRotation(this.FingerL4, speed_walk, 0.0F, 0.0F, 0.0F);
      this.progressRotation(this.StirrupL, speed_walk, 0.0F, 0.0F, 0.0F);
      this.progressRotation(this.ToeR1_1, speed_walk, -2.443461F, 3.1415927F, 0.0F);
      this.progressRotation(this.Jaw, speed_walk, -0.045553092F, 0.0F, 0.0F);
      this.progressRotation(this.BackLegR2_1, speed_walk, -2.1399481F, 0.0F, 0.0F);
      this.progressRotation(this.ToeR2_1, speed_walk, -0.2268928F, -0.2268928F, -0.34906584F);
      this.progressRotation(this.ReinR, speed_walk, -0.04363323F, 0.0F, 0.0F);
      this.progressRotation(this.StirrupR, speed_walk, 0.0F, 0.0F, 0.0F);
      this.progressRotation(this.ToeR1, speed_walk, -2.443461F, 3.1415927F, 0.0F);
      this.progressRotation(this.ToeR3, speed_walk, -0.2617994F, 0.0F, 0.0F);
      this.progressRotation(this.BackLegR1_1, speed_walk, 1.1383038F, 0.0F, 0.0F);
      this.progressRotation(this.WingL21, speed_walk, 0.0F, 0.0F, 0.0F);
      this.progressRotation(this.BeakTip, speed_walk, 0.0F, 0.0F, 0.0F);
      this.progressRotation(this.Tail2, speed_walk, 0.0F, 0.0F, 0.0F);
      this.progressRotation(this.FingerR3, speed_walk, 0.08726646F, 0.0F, 0.0F);
      this.progressRotation(this.Head, speed_walk, 0.3642502F, 0.0F, 0.0F);
      this.progressRotation(this.BackLegR1, speed_walk, 1.1838568F, 0.0F, 0.0F);
      this.progressRotation(this.HindFootR, speed_walk, 0.0F, 0.0F, 0.0F);
      this.progressRotation(this.FingerL1, speed_walk, 0.12217305F, 0.0F, 0.0F);
      this.progressRotation(this.FingerL3, speed_walk, 0.08726646F, 0.0F, 0.0F);
      this.progressRotation(this.WingR21, speed_walk, 0.0F, 0.0F, 0.0F);
      this.progressRotation(this.ToeL4, speed_walk, -0.2268928F, 0.2268928F, 0.34906584F);
      this.progressRotation(this.HindLegL, speed_walk, 1.548107F, 0.0F, 0.0F);
      this.progressRotation(this.Saddleback, speed_walk, 0.0F, 0.0F, 0.0F);
      this.progressRotation(this.FingerR1, speed_walk, 0.12217305F, 0.0F, 0.0F);
      this.progressRotation(this.WingR, speed_walk, -0.2617994F, -0.2617994F, 0.4537856F);
      this.progressRotation(this.WingR2, speed_walk, 1.548107F, 0.0F, 0.17453292F);
      this.progressRotation(this.NoseBand, speed_walk, 0.091106184F, 0.0F, 0.0F);
      this.progressRotation(this.WingL, speed_walk, -0.2617994F, 0.2617994F, -0.4537856F);
      this.progressRotation(this.FingerL2, speed_walk, 0.10471976F, 0.0F, 0.0F);
      this.progressRotation(this.ReinL, speed_walk, -0.04363323F, 0.0F, 0.0F);
      this.progressRotation(this.WingL3, speed_walk, 0.0F, 0.0F, 0.0F);
      this.progressRotation(this.Tail3, speed_walk, -0.34906584F, 0.0F, 0.0F);
      this.progressRotation(this.Saddle, speed_walk, 0.0F, 0.0F, 0.0F);
      this.progressRotation(this.FingerR2, speed_walk, 0.10471976F, 0.0F, 0.0F);
      this.progressRotation(this.HindThighL, speed_walk, 0.0F, 0.0F, 0.0F);
      this.progressRotation(this.WingR3, speed_walk, 0.0F, 0.0F, 0.0F);
      this.progressRotation(this.Neck2, speed_walk, -0.68294734F, 0.0F, 0.0F);
      this.progressRotation(this.StirrupIronR, speed_walk, 0.0F, 0.0F, 0.0F);
      this.progressRotation(this.Body, speed_walk, 0.045553092F, 0.0F, 0.0F);
      this.progressRotation(this.Neck, speed_walk, 0.7740535F, 0.0F, 0.0F);
      this.progressRotation(this.Tail1, speed_walk, -1.134464F, 0.0F, 0.0F);
      this.progressRotation(this.ToeR3_1, speed_walk, -0.2617994F, 0.0F, 0.0F);
      this.progressRotation(this.ChestR, speed_walk, 0.0F, 1.5707964F, 0.0F);
      this.progressRotation(this.SaddleFront, speed_walk, 0.0F, 0.0F, 0.0F);
      this.progressRotation(this.ToeL4_1, speed_walk, -0.2268928F, 0.2268928F, 0.34906584F);
      this.progressRotation(this.WingL2, speed_walk, 1.548107F, 0.0F, -0.17453292F);
      this.progressRotation(this.Crest1_1, speed_walk, -2.2310543F, 0.0F, 0.0F);
      this.progressRotation(this.ChestL, speed_walk, 0.0F, 1.5707964F, 0.0F);
      this.progressRotation(this.Quill_L, speed_walk, -1.1838568F, 0.17453292F, 0.0F);
      this.progressRotation(this.Quill_R, speed_walk, -1.1838568F, -0.17453292F, 0.0F);
      this.progressRotation(this.StirrupIronL, speed_walk, 0.0F, 0.0F, 0.0F);
      this.progressRotation(this.BackLegR2, speed_walk, -2.1399481F, 0.0F, 0.0F);
      this.progressRotation(this.Beak2, speed_walk, 0.0F, 0.0F, 0.0F);
      this.progressRotation(this.Crest1, speed_walk, -2.4586453F, 0.0F, 0.0F);
      this.progressRotation(this.Beak, speed_walk, 0.0F, 0.0F, 0.0F);
      this.progressRotation(this.FingerR4, speed_walk, 0.0F, 0.0F, 0.0F);
      this.progressRotation(this.HindFootL, speed_walk, 0.0F, 0.0F, 0.0F);
      this.progressRotation(this.HindThighR, speed_walk, 0.0F, 0.0F, 0.0F);
      this.progressRotation(this.ToeR2, speed_walk, -0.2268928F, -0.2268928F, -0.34906584F);
      this.progressPositionPrev(this.HindThighL, speed_walk, 0.0F, -0.75F, 0.0F);
      this.progressPositionPrev(this.HindThighR, speed_walk, 0.0F, -0.75F, 0.0F);
      speed_walk = 0.4F;
      ...
      if (!entity.isFlying() && entity.airBorneCounter <= 50 && !entity.isHovering()) {
         ...
         this.chainWave(NECK, speed_walk, degree_walk * 0.15F, -2.0D, f, f1);
         this.walk(this.BackLegR1, speed_walk, degree_walk * -0.75F, true, 0.0F, 0.0F, f, f1);
         this.walk(this.BackLegR1_1, speed_walk, degree_walk * -0.75F, false, 0.0F, 0.0F, f, f1);
         this.walk(this.BackLegR2, speed_walk, degree_walk * 0.5F, false, 0.0F, 0.0F, f, f1);
         this.walk(this.BackLegR2_1, speed_walk, degree_walk * 0.5F, true, 0.0F, 0.0F, f, f1);
         this.walk(this.HindThighR, speed_walk, degree_walk * -0.75F, false, 0.0F, 0.0F, f, f1);
         this.walk(this.HindThighL, speed_walk, degree_walk * -0.75F, true, 0.0F, 0.0F, f, f1);
         this.walk(this.HindLegR, speed_walk, degree_walk * 0.5F, true, 0.0F, 0.0F, f, f1);
         this.walk(this.HindLegL, speed_walk, degree_walk * 0.5F, false, 0.0F, 0.0F, f, f1);
         this.walk(this.HindFootR, -speed_walk, degree_walk, true, 2.75F, 0.0F, f, f1);
         this.walk(this.HindFootL, -speed_walk, degree_walk, false, 2.75F, 0.0F, f, f1);
      } else {
      ...
      if ((double)f12 < Math.toRadians(-80.0D)) {
         f12 = (float)Math.toRadians(-80.0D);
      }
