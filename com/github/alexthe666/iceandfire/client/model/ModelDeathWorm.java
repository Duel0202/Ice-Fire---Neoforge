...
public class ModelDeathWorm extends ModelDragonBase<EntityDeathWorm> {
   ...
   public ModelDeathWorm() {
      ...
      this.Body.addBox(-4.5F, -4.5F, -0.1F, 9.0F, 9.0F, 10.0F, 0.0F);
      ...
      this.Body9.addBox(-4.5F, -4.5F, -0.1F, 9.0F, 9.0F, 10.0F, 0.0F);
      this.Spine6 = new AdvancedModelBox(this, 34, 32);
      this.Spine6.setPos(0.0F, -3.5F, 2.0F);
      this.Spine6.addBox(-0.5F, -0.4F, 0.0F, 1.0F, 1.0F, 3.0F, 0.0F);
      this.setRotateAngle(this.Spine6, 1.2747885F, -0.0F, 0.0F);
      this.TailSpine3 = new AdvancedModelBox(this, 34, 28);
      this.TailSpine3.setPos(0.0F, -3.0F, 5.0F);
      this.TailSpine3.addBox(-0.5F, -0.4F, 0.0F, 1.0F, 1.0F, 2.0F, 0.0F);
      this.setRotateAngle(this.TailSpine3, 1.2747885F, -0.0F, 0.0F);
      this.Body7 = new AdvancedModelBox(this, 38, 45);
      this.Body7.setPos(0.0F, 0.0F, 4.2F);
      this.Body7.addBox(-4.5F, -4.5F, -0.1F, 9.0F, 9.0F, 10.0F, 0.0F);
      this.TailSpine1 = new AdvancedModelBox(this, 34, 32);
      this.TailSpine1.setPos(0.0F, -3.5F, 4.0F);
      this.TailSpine1.addBox(-0.5F, -0.4F, 0.0F, 1.0F, 1.0F, 3.0F, 0.0F);
      this.setRotateAngle(this.TailSpine1, 1.2747885F, -0.0F, 0.0F);
      ...
      this.Spine4.addBox(-0.5F, -0.4F, 0.0F, 1.0F, 1.0F, 3.0F, 0.0F);
      this.setRotateAngle(this.Spine4, 1.2747885F, -0.0F, 0.0F);
      this.Tail2 = new AdvancedModelBox(this, 66, 32);
      this.Tail2.setPos(0.0F, 0.0F, 7.2F);
      this.Tail2.addBox(-3.5F, -3.5F, -0.1F, 7.0F, 7.0F, 8.0F, 0.0F);
      this.Body2 = new AdvancedModelBox(this, 78, 51);
      this.Body2.setPos(0.0F, 0.0F, 9.2F);
      this.Body2.addBox(-4.0F, -4.0F, -0.1F, 8.0F, 8.0F, 5.0F, 0.0F);
      this.Spine3 = new AdvancedModelBox(this, 34, 28);
      this.Spine3.setPos(0.0F, -4.5F, 4.5F);
      this.Spine3.addBox(-0.5F, -0.4F, 0.0F, 1.0F, 1.0F, 2.0F, 0.0F);
      this.setRotateAngle(this.Spine3, 1.2747885F, -0.0F, 0.0F);
      this.Spine9 = new AdvancedModelBox(this, 34, 28);
      this.Spine9.setPos(0.0F, -4.5F, 4.5F);
      this.Spine9.addBox(-0.5F, -0.4F, 0.0F, 1.0F, 1.0F, 2.0F, 0.0F);
      this.setRotateAngle(this.Spine9, 1.2747885F, -0.0F, 0.0F);
      this.Body4 = new AdvancedModelBox(this, 78, 51);
      this.Body4.setPos(0.0F, 0.0F, 9.2F);
      this.Body4.addBox(-4.0F, -4.0F, -0.1F, 8.0F, 8.0F, 5.0F, 0.0F);
      ...
      this.Spine5.addBox(-0.5F, -0.4F, 0.0F, 1.0F, 1.0F, 2.0F, 0.0F);
      this.setRotateAngle(this.Spine5, 1.2747885F, -0.0F, 0.0F);
      ...
      this.Tail3.addBox(-3.0F, -3.0F, -0.1F, 6.0F, 6.0F, 10.0F, 0.0F);
      this.Body5 = new AdvancedModelBox(this, 38, 45);
      this.Body5.setPos(0.0F, 0.0F, 4.2F);
      this.Body5.addBox(-4.5F, -4.5F, -0.1F, 9.0F, 9.0F, 10.0F, 0.0F);
      ...
      this.Body3.addBox(-4.5F, -4.5F, -0.1F, 9.0F, 9.0F, 10.0F, 0.0F);
      this.Spine2 = new AdvancedModelBox(this, 34, 32);
      this.Spine2.setPos(0.0F, -3.5F, 2.0F);
      this.Spine2.addBox(-0.5F, -0.4F, 0.0F, 1.0F, 1.0F, 3.0F, 0.0F);
      this.setRotateAngle(this.Spine2, 1.2747885F, -0.0F, 0.0F);
      this.Body6 = new AdvancedModelBox(this, 78, 51);
      this.Body6.setPos(0.0F, 0.0F, 9.2F);
      this.Body6.addBox(-4.0F, -4.0F, -0.1F, 8.0F, 8.0F, 5.0F, 0.0F);
      this.Spine8 = new AdvancedModelBox(this, 34, 32);
      this.Spine8.setPos(0.0F, -3.5F, 2.0F);
      this.Spine8.addBox(-0.5F, -0.4F, 0.0F, 1.0F, 1.0F, 3.0F, 0.0F);
      this.setRotateAngle(this.Spine8, 1.2747885F, -0.0F, 0.0F);
      this.Tail1 = new AdvancedModelBox(this, 96, 33);
      this.Tail1.setPos(0.0F, 0.0F, 9.8F);
      this.Tail1.addBox(-4.0F, -4.0F, -0.1F, 8.0F, 8.0F, 8.0F, 0.0F);
      this.TailSpine4 = new AdvancedModelBox(this, 34, 32);
      this.TailSpine4.setPos(0.0F, -2.1F, 2.7F);
      this.TailSpine4.addBox(-0.5F, -0.4F, 0.0F, 1.0F, 1.0F, 3.0F, 0.0F);
      this.setRotateAngle(this.TailSpine4, 1.2747885F, -0.0F, 0.0F);
      ...
      this.Spine1.addBox(-0.5F, -0.4F, 0.0F, 1.0F, 1.0F, 2.0F, 0.0F);
      this.setRotateAngle(this.Spine1, 1.2747885F, -0.0F, 0.0F);
      ...
      this.Spine7.addBox(-0.5F, -0.4F, 0.0F, 1.0F, 1.0F, 2.0F, 0.0F);
      this.setRotateAngle(this.Spine7, 1.2747885F, -0.0F, 0.0F);
      this.Body8 = new AdvancedModelBox(this, 78, 51);
      this.Body8.setPos(0.0F, 0.0F, 9.2F);
      this.Body8.addBox(-4.0F, -4.0F, -0.1F, 8.0F, 8.0F, 5.0F, 0.0F);
      ...
      this.Tail4.addBox(-2.5F, -2.5F, -0.1F, 5.0F, 5.0F, 10.0F, 0.0F);
      this.TailSpine5 = new AdvancedModelBox(this, 34, 28);
      this.TailSpine5.setPos(0.0F, -2.1F, 8.0F);
      this.TailSpine5.addBox(-0.5F, -0.4F, 0.0F, 1.0F, 1.0F, 2.0F, 0.0F);
      this.setRotateAngle(this.TailSpine5, 1.2747885F, -0.0F, 0.0F);
      this.TailSpine2 = new AdvancedModelBox(this, 34, 32);
      this.TailSpine2.setPos(0.0F, -3.0F, 4.0F);
      this.TailSpine2.addBox(-0.5F, -0.4F, 0.0F, 1.0F, 1.0F, 3.0F, 0.0F);
      this.setRotateAngle(this.TailSpine2, 1.2747885F, -0.0F, 0.0F);
   ...
   public void animate(IAnimatedEntity entity, float f, float f1, float f2, float f3, float f4) {
      ...
      if (this.animator.setAnimation(EntityDeathWorm.ANIMATION_BITE)) {
         ...
         this.rotate(this.animator, this.TopJaw, -20.0F, 0.0F, 0.0F);
         ...
         this.animator.startKeyframe(3);
         this.rotate(this.animator, this.TopJaw, -40.0F, 0.0F, 0.0F);
         this.rotate(this.animator, this.BottomJaw, 40.0F, 0.0F, 0.0F);
         this.animator.move(this.JawExtender, 0.0F, 0.0F, -10.0F);
         this.animator.move(this.JawExtender2, 0.0F, 0.0F, -10.0F);
         this.animator.endKeyframe();
         this.animator.startKeyframe(2);
         this.rotate(this.animator, this.TopJaw, 5.0F, 0.0F, 0.0F);
         this.rotate(this.animator, this.BottomJaw, -5.0F, 0.0F, 0.0F);
   ...
   public void setupAnim(EntityDeathWorm entity, float f, float f1, float f2, float f3, float f4) {
      ...
      AdvancedModelBox[] WORM = new AdvancedModelBox[]{this.Body, this.Body2, this.Body3, this.Body4, this.Body5, this.Body6, this.Body7, this.Body8, this.Body9, this.Tail1, this.Tail2, this.Tail3, this.Tail4};
      this.walk(this.ToothT, speed_idle, degree_idle * 0.15F, true, 0.1F, 0.0F, f2, 1.0F);
      this.walk(this.ToothB, speed_idle, degree_idle * 0.15F, false, 0.1F, 0.0F, f2, 1.0F);
      this.swing(this.ToothL, speed_idle, degree_idle * 0.15F, true, 0.1F, 0.0F, f2, 1.0F);
      this.swing(this.ToothL_1, speed_idle, degree_idle * 0.15F, false, 0.1F, 0.0F, f2, 1.0F);
      this.walk(this.TopJaw, speed_idle * 0.5F, degree_idle * 0.15F, true, -0.1F, 0.0F, f2, 1.0F);
      this.walk(this.BottomJaw, speed_idle * 0.5F, degree_idle * 0.15F, false, -0.1F, 0.0F, f2, 1.0F);
      this.chainSwing(WORM, speed_walk, degree_walk * 0.1F, -3.0D, f2, 1.0F);
      this.chainSwing(WORM, speed_walk, degree_walk, -3.0D, f, f1);
      this.chainFlap(WORM, speed_walk, degree_walk * 0.75F, -3.0D, f, f1);
      float jumpProgress = entity.prevJumpProgress + (entity.jumpProgress - entity.prevJumpProgress) * (f2 - (float)entity.f_19797_);
      this.progressRotation(this.Head, jumpProgress, (float)Math.toRadians(25.0D), 0.0F, 0.0F);
      this.progressRotation(this.Body, jumpProgress, (float)Math.toRadians(65.0D), 0.0F, 0.0F);
      this.progressRotation(this.Body2, jumpProgress, (float)Math.toRadians(-21.0D), 0.0F, 0.0F);
      this.progressRotation(this.Body3, jumpProgress, (float)Math.toRadians(-21.0D), 0.0F, 0.0F);
      this.progressRotation(this.Body4, jumpProgress, (float)Math.toRadians(-21.0D), 0.0F, 0.0F);
      this.progressRotation(this.Body5, jumpProgress, (float)Math.toRadians(-21.0D), 0.0F, 0.0F);
      this.progressRotation(this.Body6, jumpProgress, (float)Math.toRadians(-21.0D), 0.0F, 0.0F);
      this.progressRotation(this.Body8, jumpProgress, (float)Math.toRadians(-21.0D), 0.0F, 0.0F);
      this.progressRotation(this.Body9, jumpProgress, (float)Math.toRadians(-21.0D), 0.0F, 0.0F);
      this.progressRotation(this.Tail1, jumpProgress, (float)Math.toRadians(-21.0D), 0.0F, 0.0F);
      this.progressRotation(this.Tail2, jumpProgress, (float)Math.toRadians(-21.0D), 0.0F, 0.0F);
      this.progressRotation(this.Tail3, jumpProgress, (float)Math.toRadians(-21.0D), 0.0F, 0.0F);
      this.progressRotation(this.Tail4, jumpProgress, (float)Math.toRadians(-21.0D), 0.0F, 0.0F);
      if (entity.tail_buffer != null) {
         entity.tail_buffer.applyChainSwingBuffer(WORM);
      }

      if (entity.getWormJumping() > 0) {
         AdvancedModelBox var10000 = this.Body;
         var10000.rotateAngleX += f4 * 0.017453292F;
      }
