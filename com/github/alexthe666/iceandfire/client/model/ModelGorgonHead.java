...
public class ModelGorgonHead extends AdvancedEntityModel<Entity> {
   ...
   public ModelGorgonHead() {
      ...
      this.setRotateAngle(this.SnakeBodyR6, 0.39303768F, -0.072472036F, -0.6553711F);
      ...
      this.setRotateAngle(this.SnakeBaseL4, -0.7978523F, 0.67075413F, 0.5629543F);
      ...
      this.setRotateAngle(this.SnakeBodyL3, 1.6756907F, 0.964818F, -2.1399481F);
      ...
      this.setRotateAngle(this.SnakeBaseR7, -1.899329F, -0.23271061F, -2.7251983F);
      ...
      this.setRotateAngle(this.SnakeBodyR2, 0.5009095F, 0.0F, -0.59184116F);
      ...
      this.setRotateAngle(this.SnakeBodyR3, 1.500285F, -1.4570009F, 1.1383038F);
      ...
      this.setRotateAngle(this.SnakeHeadL7, 0.8813913F, 0.68294734F, -1.548107F);
      ...
      this.setRotateAngle(this.SnakeBodyL5, 0.6981317F, -0.11635552F, 0.27925268F);
      ...
      this.setRotateAngle(this.SnakeBaseR6, -1.7976891F, 0.7740535F, -2.4586453F);
      ...
      this.setRotateAngle(this.SnakeBodyL1, 1.3203416F, 0.091106184F, -0.13665928F);
      ...
      this.setRotateAngle(this.SnakeHeadR4, 0.51975906F, 0.0F, 3.1415927F);
      ...
      this.setRotateAngle(this.SnakeBaseR4, -4.0857615F, 0.0F, -0.2617994F);
      ...
      this.setRotateAngle(this.SnakeBodyR5, 0.6981317F, -0.07528851F, -0.27925268F);
      ...
      this.setRotateAngle(this.SnakeBaseL5, -2.1994638F, 0.6783035F, 2.2558382F);
      ...
      this.setRotateAngle(this.SnakeBodyL7, 0.22759093F, 0.4098033F, 0.0F);
      ...
      this.setRotateAngle(this.snakeBodyL6, 1.3786355F, 0.59184116F, -0.59184116F);
      ...
      this.setRotateAngle(this.SnakeBodyL4, 1.515993F, 0.780265F, 0.0F);
      ...
      this.setRotateAngle(this.SnakeBodyR7, 1.324397F, -0.26442397F, 0.0F);
      ...
      this.setRotateAngle(this.SnakeBaseL7, -1.5707964F, 0.0F, 2.7317894F);
      ...
      this.setRotateAngle(this.SnakeBaseL1, -0.91053826F, -1.4114478F, 0.4098033F);
      ...
      this.setRotateAngle(this.SnakeBaseL3, -1.796642F, 0.24940754F, 0.9203121F);
      ...
      this.setRotateAngle(this.SnakeBodyL2, 0.8651597F, 0.045553092F, 0.0F);
      ...
      this.setRotateAngle(this.SnakeBaseR3, -1.796642F, 0.63739425F, -1.4114478F);
      ...
      this.setRotateAngle(this.SnakeBaseR1, -0.892835F, 0.93084246F, -0.2268928F);
      ...
      this.setRotateAngle(this.SnakeBodyR4, -0.22759093F, 0.0F, 0.0F);
      ...
      this.setRotateAngle(this.SnakeHeadR1, 0.5009095F, -0.067718774F, 0.20333086F);
      ...
      this.setRotateAngle(this.SnakeHeadL1, 0.22759093F, 0.067718774F, -0.20333086F);
