...
public class ModelMyrmexRoyal extends ModelMyrmexBase {
   ...
   public ModelMyrmexRoyal() {
      ...
      this.setRotateAngle(this.wingL2, -0.17453292F, -0.08726646F, -0.08726646F);
      ...
      this.setRotateAngle(this.wingL, -0.10471976F, -0.2617994F, -0.20943952F);
      ...
      this.setRotateAngle(this.wingR, -0.10471976F, 0.2617994F, 0.20943952F);
      ...
      this.setRotateAngle(this.wingR2, -0.17453292F, 0.08726646F, 0.08726646F);
   ...
   public void m_6973_(Entity entity, float f, float f1, float f2, float f3, float f4) {
      ...
      if (myrmex.isFlying() && !myrmex.m_20096_()) {
         this.chainWave(LEFT_WINGS, speed_fly, degree_fly * 0.75F, 2.0D, f2, 1.0F);
         this.chainWave(RIGHT_WINGS, speed_fly, degree_fly * 0.75F, 2.0D, f2, 1.0F);
      ...
      this.progressRotation(this.HeadBase, myrmex.flyProgress, (float)Math.toRadians(52.0D), 0.0F, 0.0F);
      this.progressPosition(this.Body2, myrmex.flyProgress, 0.0F, -8.0F, 0.0F);
      this.progressRotation(this.Body4, myrmex.flyProgress, (float)Math.toRadians(-18.0D), 0.0F, 0.0F);
      this.progressRotation(this.Body5, myrmex.flyProgress, (float)Math.toRadians(-2.0D), 0.0F, 0.0F);
      this.progressRotation(this.Tail1, myrmex.flyProgress, (float)Math.toRadians(-5.0D), 0.0F, 0.0F);
      this.progressRotation(this.Tail2, myrmex.flyProgress, (float)Math.toRadians(-13.0D), 0.0F, 0.0F);
      this.progressRotation(this.Stinger, myrmex.flyProgress, (float)Math.toRadians(36.0D), 0.0F, 0.0F);
      this.progressRotation(this.legTopR1, myrmex.flyProgress, (float)Math.toRadians(-28.0D), (float)Math.toRadians(-13.0D), (float)Math.toRadians(40.0D));
      this.progressRotation(this.legTopR1_1, myrmex.flyProgress, (float)Math.toRadians(-28.0D), (float)Math.toRadians(13.0D), (float)Math.toRadians(-40.0D));
      this.progressRotation(this.legTopR2, myrmex.flyProgress, 0.0F, 0.0F, (float)Math.toRadians(-40.0D));
      this.progressRotation(this.legTopR2_1, myrmex.flyProgress, 0.0F, 0.0F, (float)Math.toRadians(40.0D));
      this.progressRotation(this.legTopR3, myrmex.flyProgress, (float)Math.toRadians(28.0D), (float)Math.toRadians(13.0D), (float)Math.toRadians(44.0D));
      this.progressRotation(this.legTopR3_1, myrmex.flyProgress, (float)Math.toRadians(28.0D), (float)Math.toRadians(-13.0D), (float)Math.toRadians(-44.0D));
      this.progressRotation(this.legMidR1, myrmex.flyProgress, 0.0F, 0.0F, (float)Math.toRadians(-30.0D));
      this.progressRotation(this.legMidR2, myrmex.flyProgress, 0.0F, 0.0F, (float)Math.toRadians(30.0D));
      this.progressRotation(this.legMidR3, myrmex.flyProgress, 0.0F, 0.0F, (float)Math.toRadians(-30.0D));
      this.progressRotation(this.legMidR1_1, myrmex.flyProgress, 0.0F, 0.0F, (float)Math.toRadians(30.0D));
      this.progressRotation(this.legMidR2_1, myrmex.flyProgress, 0.0F, 0.0F, (float)Math.toRadians(-30.0D));
      this.progressRotation(this.legMidR3_1, myrmex.flyProgress, 0.0F, 0.0F, (float)Math.toRadians(30.0D));
      this.progressRotation(this.legBottomR1, myrmex.flyProgress, 0.0F, 0.0F, (float)Math.toRadians(-15.0D));
      this.progressRotation(this.legBottomR2, myrmex.flyProgress, 0.0F, 0.0F, (float)Math.toRadians(15.0D));
      this.progressRotation(this.legBottomR3, myrmex.flyProgress, 0.0F, 0.0F, (float)Math.toRadians(-15.0D));
      this.progressRotation(this.legBottomR1_1, myrmex.flyProgress, 0.0F, 0.0F, (float)Math.toRadians(15.0D));
      this.progressRotation(this.legBottomR2_1, myrmex.flyProgress, 0.0F, 0.0F, (float)Math.toRadians(-15.0D));
      this.progressRotation(this.legBottomR3_1, myrmex.flyProgress, 0.0F, 0.0F, (float)Math.toRadians(15.0D));
      this.progressRotation(this.wingL, myrmex.flyProgress, (float)Math.toRadians(6.0D), (float)Math.toRadians(60.0D), (float)Math.toRadians(-12.0D));
      this.progressRotation(this.wingR, myrmex.flyProgress, (float)Math.toRadians(6.0D), (float)Math.toRadians(-60.0D), (float)Math.toRadians(12.0D));
      this.progressRotation(this.wingR2, myrmex.flyProgress, 0.0F, (float)Math.toRadians(40.0D), (float)Math.toRadians(12.0D));
      this.progressRotation(this.wingL2, myrmex.flyProgress, 0.0F, (float)Math.toRadians(-40.0D), (float)Math.toRadians(-12.0D));
   }
