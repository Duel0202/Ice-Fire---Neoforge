...
public class ModelHydraHead extends ModelDragonBase<EntityHydra> {
   ...
   public ModelHydraHead(int headIndex) {
      ...
      this.setRotateAngle(this.Head1, 0.7853982F, -0.0F, 0.0F);
      ...
      this.setRotateAngle(this.Neck2, -0.5235988F, 0.0F, 0.0F);
      ...
      this.setRotateAngle(this.Neck1, -0.34906584F, 0.0F, 0.0F);
      ...
      this.setRotateAngle(this.TeethL1, 0.045553092F, -0.0F, -3.1415927F);
   ...
   public void setupAnim(EntityHydra entity, float f, float f1, float f2, float f3, float f4) {
      ...
      if (!EntityGorgon.isStoneMob(entity)) {
         ...
         this.chainSwing(ENTIRE_HEAD, speed_walk, degree_walk * 0.75F, -3.0D, f, f1);
         ...
         this.progressRotationInterp(this.LowerJaw1, Mth.m_14031_((float)((double)speakProgress * 3.141592653589793D)) * 10.0F, (float)Math.toRadians(25.0D), 0.0F, 0.0F, 10.0F);
         ...
         this.progressRotationInterp(this.Neck2, strikeProgress, (float)Math.toRadians(5.0D), 0.0F, 0.0F, 10.0F);
         this.progressRotationInterp(this.Neck3, strikeProgress, (float)Math.toRadians(5.0D), 0.0F, 0.0F, 10.0F);
         this.progressRotationInterp(this.Neck4, strikeProgress, (float)Math.toRadians(5.0D), 0.0F, 0.0F, 10.0F);
         this.progressRotationInterp(this.Head1, strikeProgress, (float)Math.toRadians(-15.0D), 0.0F, 0.0F, 10.0F);
         this.progressRotationInterp(this.LowerJaw1, strikeProgress, (float)Math.toRadians(45.0D), 0.0F, 0.0F, 10.0F);
         ...
         this.progressRotationInterp(this.Neck4, breathProgress, (float)Math.toRadians(15.0D), 0.0F, 0.0F, 10.0F);
         this.progressRotationInterp(this.Neck3, breathProgress, (float)Math.toRadians(15.0D), 0.0F, 0.0F, 10.0F);
         this.progressPositionInterp(this.TeethTR1, breathProgress, 0.5F, 0.0F, 0.0F, 10.0F);
         this.progressRotationInterp(this.Head1, breathProgress, (float)Math.toRadians(15.0D), 0.0F, 0.0F, 10.0F);
         this.progressRotationInterp(this.UpperJaw1, breathProgress, (float)Math.toRadians(-10.0D), 0.0F, 0.0F, 10.0F);
         this.progressRotationInterp(this.LowerJaw1, breathProgress, (float)Math.toRadians(50.0D), 0.0F, 0.0F, 10.0F);
