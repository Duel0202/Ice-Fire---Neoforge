...
public class ModelAmphithere extends ModelDragonBase<EntityAmphithere> {
   ...
   public ModelAmphithere() {
      ...
      this.setRotateAngle(this.TailR1, 1.3962634F, 0.06981317F, 0.0F);
      ...
      this.setRotateAngle(this.CrestL3, 1.7453293F, 0.87266463F, 0.7853982F);
      ...
      this.setRotateAngle(this.TailL2, 1.3962634F, 0.31869712F, 0.0F);
      ...
      this.setRotateAngle(this.CrestLB, 1.7453293F, 0.27314404F, 0.0F);
      ...
      this.setRotateAngle(this.TailL1, 1.3962634F, -0.06981317F, 0.0F);
      ...
      this.setRotateAngle(this.CrestR2, 1.7453293F, -0.61086524F, -0.31415927F);
      ...
      this.setRotateAngle(this.WingL3, 0.5235988F, 0.0F, 0.0F);
      ...
      this.setRotateAngle(this.FingerR4, 0.2617994F, 0.0F, 0.0F);
      ...
      this.setRotateAngle(this.WingR2, -0.34906584F, 0.0F, 0.0F);
      ...
      this.setRotateAngle(this.WingR, 0.08726646F, 0.0F, 1.3962634F);
      ...
      this.setRotateAngle(this.WingL2, -0.34906584F, 0.0F, 0.0F);
      ...
      this.setRotateAngle(this.CrestL2, 1.7453293F, 0.61086524F, 0.31415927F);
      ...
      this.setRotateAngle(this.Beak, 0.6981317F, -0.0F, 0.0F);
      ...
      this.setRotateAngle(this.WingL, 0.08726646F, 0.0F, -1.3962634F);
      ...
      this.setRotateAngle(this.CrestL1, 1.7453293F, 0.08726646F, 0.0F);
      ...
      this.setRotateAngle(this.CrestR1, 1.7453293F, -0.08726646F, 0.0F);
      ...
      this.setRotateAngle(this.FingerL4, 0.2617994F, 0.0F, 0.0F);
      ...
      this.setRotateAngle(this.TailR2, 1.3962634F, -0.31869712F, 0.0F);
      ...
      this.setRotateAngle(this.CrestRB, 1.7453293F, -0.27314404F, 0.0F);
      ...
      this.setRotateAngle(this.WingR3, 0.5235988F, 0.0F, 0.0F);
   ...
   public void setupAnim(EntityAmphithere amphithere, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
      ...
      if (amphithere.groundProgress >= 10.0F) {
         this.chainSwing(ENTIRE_BODY, speed_walk, 0.125F, 2.0D, limbSwing, limbSwingAmount);
         this.chainSwing(NECK, speed_walk, -degree_walk, 4.0D, limbSwing, limbSwingAmount);
      }

      this.chainWave(NECK, speed_idle, degree_idle * 0.15F, 4.0D, ageInTicks, 1.0F);
      this.chainSwing(TAIL, speed_idle, degree_idle * 0.1F, 2.0D, ageInTicks, 1.0F);
      ...
      this.progressRotation(this.FingerR4, sitProgress, 0.2617994F, 0.0F, 0.0F);
      this.progressRotation(this.WingL2, sitProgress, -0.34906584F, 0.0F, 0.34906584F);
      ...
      this.progressRotation(this.FingerL4, sitProgress, 0.2617994F, 0.0F, 0.0F);
      this.progressRotation(this.WingR3, sitProgress, 1.4835298F, 0.0F, 0.0F);
      this.progressRotation(this.WingR2, sitProgress, -0.34906584F, 0.0F, -0.34906584F);
      ...
      this.progressRotation(this.CrestR2, sitProgress, 1.7453293F, -0.61086524F, -0.31415927F);
      this.progressRotation(this.FingerR4, sitProgress, -0.2617994F, 0.0F, 0.0F);
      this.progressRotation(this.TailL1, sitProgress, 1.3962634F, -0.06981317F, 0.0F);
      ...
      this.progressRotation(this.Beak, sitProgress, 0.6981317F, -0.0F, 0.0F);
      ...
      this.progressRotation(this.CrestLB, sitProgress, 1.7453293F, 0.27314404F, 0.0F);
      ...
      this.progressRotation(this.WingR3, sitProgress, 0.12217305F, -0.17453292F, -0.12217305F);
      ...
      this.progressRotation(this.WingL3, sitProgress, 0.12217305F, 0.17453292F, 0.12217305F);
      ...
      this.progressRotation(this.CrestRB, sitProgress, 1.7453293F, -0.27314404F, 0.0F);
      this.progressRotation(this.BodyLower, sitProgress, -0.13665928F, 0.0F, 0.0F);
      this.progressRotation(this.CrestR3, sitProgress, 1.7453293F, -0.87266463F, -0.7285004F);
      ...
      this.progressRotation(this.TailL2, sitProgress, 1.3962634F, 0.31869712F, 0.0F);
      this.progressRotation(this.FingerL3, sitProgress, -0.13962634F, 0.0F, 0.0F);
      this.progressRotation(this.CrestL3, sitProgress, 1.7453293F, 0.87266463F, 0.7853982F);
      this.progressRotation(this.CrestL2, sitProgress, 1.7453293F, 0.61086524F, 0.31415927F);
      this.progressRotation(this.WingR21, sitProgress, 0.0F, 0.0F, 0.0F);
      this.progressRotation(this.TailR1, sitProgress, 1.3962634F, 0.06981317F, 0.0F);
      this.progressRotation(this.Head, sitProgress, 0.8196066F, -0.0F, 0.0F);
      this.progressRotation(this.WingR2, sitProgress, 1.4835298F, 0.0F, 0.17453292F);
      this.progressRotation(this.WingL, sitProgress, 0.08726646F, 0.0F, -1.134464F);
      this.progressRotation(this.CrestR1, sitProgress, 1.7453293F, -0.08726646F, 0.0F);
      this.progressRotation(this.WingL2, sitProgress, 1.4835298F, 0.0F, -0.17453292F);
      this.progressRotation(this.Tail3, sitProgress, 0.045553092F, 0.0F, 0.0F);
      this.progressRotation(this.TailR2, sitProgress, 1.3962634F, -0.31869712F, 0.0F);
      this.progressRotation(this.CrestL1, sitProgress, 1.7453293F, 0.08726646F, 0.0F);
