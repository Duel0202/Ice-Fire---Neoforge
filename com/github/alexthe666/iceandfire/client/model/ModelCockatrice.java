...
public class ModelCockatrice extends ModelDragonBase<EntityCockatrice> {
   ...
   public ModelCockatrice() {
      ...
      this.lowerBody.addBox(-4.0F, -1.0F, 0.0F, 8.0F, 8.0F, 9.0F, 0.0F);
      this.setRotateAngle(this.lowerBody, -0.15550883F, 0.0F, 0.0F);
      this.Wattle = new AdvancedModelBox(this, 47, 9);
      this.Wattle.mirror = true;
      this.Wattle.setPos(-0.0F, -2.1F, -2.03F);
      this.Wattle.addBox(-0.5F, -1.5F, 0.6F, 1.0F, 4.0F, 5.0F, 0.0F);
      this.setRotateAngle(this.Wattle, -1.5934856F, -0.0F, 0.0F);
      this.TailPlume = new AdvancedModelBox(this, 37, 31);
      this.TailPlume.setPos(0.0F, 0.9F, 7.3F);
      this.TailPlume.addBox(-0.5F, -9.1F, -0.2F, 1.0F, 7.0F, 5.0F, 0.0F);
      this.setRotateAngle(this.TailPlume, -0.7740535F, -0.0F, 0.0F);
      this.upperBody = new AdvancedModelBox(this, 67, 5);
      this.upperBody.setPos(0.0F, 1.1F, -2.0F);
      this.upperBody.addBox(-3.0F, -2.0F, -5.0F, 6.0F, 7.0F, 8.0F, 0.0F);
      ...
      this.leftLowerArmWing.addBox(-0.5F, 0.0F, -8.0F, 1.0F, 12.0F, 8.0F, 0.0F);
      this.setRotateAngle(this.leftLowerArmWing, 0.013613569F, -0.0F, 0.0F);
      this.upperJaw = new AdvancedModelBox(this, 28, 0);
      this.upperJaw.setPos(0.0F, -1.0F, -4.93F);
      this.upperJaw.addBox(-1.5F, -2.4F, -4.0F, 3.0F, 3.0F, 4.0F, 0.0F);
      ...
      this.leftUpperArm.addBox(0.0F, -1.0F, -1.0F, 2.0F, 5.0F, 3.0F, 0.0F);
      ...
      this.neck.addBox(-2.0F, -2.0F, -6.5F, 4.0F, 5.0F, 7.0F, 0.0F);
      ...
      this.RightUpperArm.addBox(-2.0F, -1.0F, -1.0F, 2.0F, 5.0F, 3.0F, 0.0F);
      ...
      this.Comb1.addBox(-0.5F, -1.5F, 0.6F, 1.0F, 4.0F, 5.0F, 0.0F);
      this.setRotateAngle(this.Comb1, 1.2292354F, -0.0F, 0.0F);
      ...
      this.RightLowerArm.addBox(-1.0F, 0.0F, -6.0F, 2.0F, 2.0F, 6.0F, 0.0F);
      this.setRotateAngle(this.RightLowerArm, 0.7042404F, -0.0F, 0.0F);
      ...
      this.RightUpperArmWing.addBox(-0.5F, 0.0F, -3.5F, 1.0F, 4.0F, 7.0F, 0.0F);
      ...
      this.RightLowerArmWing.addBox(-0.5F, 0.0F, -8.0F, 1.0F, 12.0F, 8.0F, 0.0F);
      this.setRotateAngle(this.RightLowerArmWing, 0.013613569F, -0.0F, 0.0F);
      this.tail3 = new AdvancedModelBox(this, 49, 16);
      this.tail3.setPos(0.0F, 0.3F, 7.2F);
      this.tail3.addBox(-1.0F, 0.0F, 0.0F, 2.0F, 3.0F, 12.0F, 0.0F);
      ...
      this.tail4.addBox(-1.02F, -0.2F, 0.1F, 2.0F, 2.0F, 12.0F, 0.0F);
      this.setRotateAngle(this.tail4, -0.05253441F, -0.0F, 0.0F);
      this.tail2 = new AdvancedModelBox(this, 90, 13);
      this.tail2.setPos(0.0F, 0.2F, 6.7F);
      this.tail2.addBox(-1.5F, 0.0F, 0.0F, 3.0F, 4.0F, 8.0F, 0.0F);
      this.leftLowerArm = new AdvancedModelBox(this, 0, 12);
      this.leftLowerArm.mirror = true;
      this.leftLowerArm.setPos(0.9F, 3.0F, 0.0F);
      this.leftLowerArm.addBox(-1.0F, 0.0F, -6.0F, 2.0F, 2.0F, 6.0F, 0.0F);
      this.setRotateAngle(this.leftLowerArm, 0.7042404F, -0.0F, 0.0F);
      this.tail1 = new AdvancedModelBox(this, 91, 0);
      this.tail1.setPos(0.0F, -1.0F, 8.5F);
      this.tail1.addBox(-2.0F, 0.0F, 0.0F, 4.0F, 5.0F, 7.0F, 0.0F);
      this.setRotateAngle(this.tail1, 0.11903145F, -0.0F, 0.0F);
      this.TailPlume_1 = new AdvancedModelBox(this, 35, 29);
      this.TailPlume_1.setPos(0.0F, 1.2F, 3.5F);
      this.TailPlume_1.addBox(-0.5F, -11.5F, -0.4F, 1.0F, 10.0F, 6.0F, 0.0F);
      this.setRotateAngle(this.TailPlume_1, -0.5009095F, -0.0F, 0.0F);
      this.Comb2 = new AdvancedModelBox(this, 38, 15);
      this.Comb2.setPos(-0.0F, -0.7F, -1.03F);
      this.Comb2.addBox(-0.52F, -1.5F, 0.6F, 1.0F, 4.0F, 5.0F, 0.0F);
      this.setRotateAngle(this.Comb2, 1.1383038F, 0.0F, 0.0F);
      this.leftUpperArmWing = new AdvancedModelBox(this, 22, 10);
      this.leftUpperArmWing.setPos(1.4F, 2.7F, 1.1F);
      this.leftUpperArmWing.addBox(-0.5F, 0.0F, -3.5F, 1.0F, 4.0F, 7.0F, 0.0F);
      ...
      this.lowerJaw.addBox(-1.5F, -0.5F, -4.3F, 3.0F, 1.0F, 4.0F, 0.0F);
      ...
      this.upperJaw_1.addBox(-0.5F, -0.5F, -2.9F, 1.0F, 1.0F, 3.0F, 0.0F);
      this.setRotateAngle(this.upperJaw_1, 1.3658947F, -0.0F, 0.0F);
   ...
   public Iterable<AdvancedModelBox> getAllParts() {
      return ImmutableList.of(this.lowerBody, this.leftThigh, this.rightThigh, this.upperBody, this.tail1, this.neck, this.leftUpperArm, this.RightUpperArm, this.neck2, this.head, this.upperJaw, this.lowerJaw, new AdvancedModelBox[]{this.Comb1, this.Comb2, this.Wattle, this.upperJaw_1, this.leftLowerArm, this.leftUpperArmWing, this.leftLowerArmWing, this.RightLowerArm, this.RightUpperArmWing, this.RightLowerArmWing, this.tail2, this.tail3, this.rightToeClaw2, this.tail4, this.TailPlume, this.TailPlume_1, this.leftLeg, this.leftFoot, this.rightLeg, this.rightFoot});
   }
   ...
   public void animate(IAnimatedEntity entity, float f, float f1, float f2, float f3, float f4) {
      ...
      if (this.animator.setAnimation(EntityCockatrice.ANIMATION_WATTLESHAKE)) {
         ...
         this.rotate(this.animator, this.Comb1, 0.0F, 0.0F, -23.0F);
         this.rotate(this.animator, this.Comb2, 0.0F, 0.0F, -27.0F);
         this.rotate(this.animator, this.Wattle, 0.0F, 0.0F, -23.0F);
         this.animator.endKeyframe();
         this.animator.startKeyframe(2);
         this.rotate(this.animator, this.neck, 0.0F, 0.0F, -23.0F);
         this.rotate(this.animator, this.neck2, 0.0F, 0.0F, -13.0F);
         this.rotate(this.animator, this.head, 5.0F, 0.0F, -15.0F);
         this.rotate(this.animator, this.Comb1, 0.0F, 0.0F, -33.0F);
         this.rotate(this.animator, this.Comb2, 0.0F, 0.0F, -37.0F);
         this.rotate(this.animator, this.Wattle, 0.0F, 0.0F, -33.0F);
         this.animator.endKeyframe();
         this.animator.startKeyframe(3);
         this.rotate(this.animator, this.neck, 0.0F, 0.0F, 23.0F);
         this.rotate(this.animator, this.neck2, 0.0F, 0.0F, 13.0F);
   ...
   public void setupAnim(EntityCockatrice entity, float f, float f1, float f2, float f3, float f4) {
      ...
      this.walk(this.leftLowerArm, speed_idle, degree_idle * 0.2F, false, 1.0F, 0.1F, f2, 1.0F);
      this.walk(this.RightLowerArm, speed_idle, degree_idle * 0.2F, false, 1.0F, 0.1F, f2, 1.0F);
