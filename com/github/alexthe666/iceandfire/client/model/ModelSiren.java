...
public class ModelSiren extends ModelDragonBase<EntitySiren> {
   ...
   public ModelSiren() {
      ...
      this.setRotateAngle(this.Left_Arm, -0.6981317F, 0.0F, 0.0F);
      ...
      this.setRotateAngle(this.Tail_1, 1.5707964F, 0.0F, 0.0F);
      ...
      this.setRotateAngle(this.FlukeL, -0.034906585F, -0.08726646F, -0.5235988F);
      ...
      this.setRotateAngle(this.FlukeR, -0.034906585F, 0.08726646F, 0.5235988F);
      ...
      this.setRotateAngle(this.Right_Arm, -0.6981317F, 0.045553092F, 0.0F);
   ...
   public void setupAnim(EntitySiren entity, float f, float f1, float f2, float f3, float f4) {
      ...
      this.progressRotation(this.Body, entity.swimProgress, (float)Math.toRadians(-2.0D), 0.0F, 0.0F);
      this.progressRotation(this.Head, entity.swimProgress, (float)Math.toRadians(-70.0D), 0.0F, 0.0F);
      this.progressRotation(this.Left_Arm, entity.swimProgress, (float)Math.toRadians(-15.0D), 0.0F, 0.0F);
      this.progressRotation(this.Right_Arm, entity.swimProgress, (float)Math.toRadians(-15.0D), 0.0F, 0.0F);
      if (entity.m_6069_()) {
         ...
         this.chainWave(TAIL_NO_BASE, speed_walk, degree_walk * 0.4F, 0.0D, f, f1);
         ...
         this.chainFlap(TAIL_NO_BASE, speed_walk, degree_walk * 0.6F, 1.0D, f, f1);
      ...
      if (entity.isSinging()) {
         ...
         case 1:
            this.progressRotation(this.Body, entity.singProgress, (float)Math.toRadians(-57.0D), 0.0F, 0.0F);
            this.progressRotation(this.Head, entity.singProgress, (float)Math.toRadians(-13.0D), 0.0F, 0.0F);
            this.progressRotation(this.Left_Arm, entity.singProgress, (float)Math.toRadians(-200.0D), (float)Math.toRadians(-60.0D), (float)Math.toRadians(70.0D));
            this.progressRotation(this.Right_Arm, entity.singProgress, (float)Math.toRadians(-200.0D), (float)Math.toRadians(60.0D), (float)Math.toRadians(-70.0D));
            this.progressRotation(this.Tail_1, entity.singProgress, (float)Math.toRadians(70.0D), 0.0F, 0.0F);
            this.progressRotation(this.Tail_2, entity.singProgress, (float)Math.toRadians(20.0D), 0.0F, (float)Math.toRadians(25.0D));
            this.progressRotation(this.Tail_3, entity.singProgress, 0.0F, 0.0F, (float)Math.toRadians(18.0D));
            ...
            if (entity.m_20096_()) {
               this.chainFlap(TAIL_NO_BASE, speed_idle, degree_idle, 0.0D, f2, 1.0F);
            }
            break;
         case 2:
            this.progressRotation(this.Body, entity.singProgress, (float)Math.toRadians(-46.0D), 0.0F, 0.0F);
            this.progressRotation(this.Tail_1, entity.singProgress, (float)Math.toRadians(90.0D), 0.0F, (float)Math.toRadians(20.0D));
            this.progressRotation(this.Tail_2, entity.singProgress, 0.0F, (float)Math.toRadians(-13.0D), 0.0F);
            this.progressRotation(this.Tail_3, entity.singProgress, 0.0F, (float)Math.toRadians(-7.0D), 0.0F);
            this.progressRotation(this.Head, entity.singProgress, (float)Math.toRadians(-52.0D), (float)Math.toRadians(2.0D), (float)Math.toRadians(-26.0D));
            this.progressRotation(this.Left_Arm, entity.singProgress, (float)Math.toRadians(-40.0D), (float)Math.toRadians(-28.0D), (float)Math.toRadians(-26.0D));
            this.progressRotation(this.Right_Arm, entity.singProgress, (float)Math.toRadians(13.0D), (float)Math.toRadians(73.0D), (float)Math.toRadians(130.0D));
            ...
            break;
         default:
            this.progressRotation(this.Body, entity.singProgress, (float)Math.toRadians(-46.0D), 0.0F, (float)Math.toRadians(20.8700008392334D));
            this.progressPosition(this.Head, entity.singProgress, 0.0F, -12.0F, -0.5F);
            this.progressRotation(this.Head, entity.singProgress, (float)Math.toRadians(-54.0D), 0.0F, (float)Math.toRadians(20.8700008392334D));
            this.progressRotation(this.Tail_1, entity.singProgress, (float)Math.toRadians(90.0D), (float)Math.toRadians(20.8700008392334D), 0.0F);
            this.progressRotation(this.Tail_2, entity.singProgress, 0.0F, 0.0F, (float)Math.toRadians(-33.0D));
            this.progressRotation(this.Tail_2, entity.singProgress, 0.0F, 0.0F, (float)Math.toRadians(-15.0D));
            this.progressRotation(this.Right_Arm, entity.singProgress, (float)Math.toRadians(-40.0D), (float)Math.toRadians(2.0D), (float)Math.toRadians(53.0D));
            this.progressRotation(this.Left_Arm, entity.singProgress, (float)Math.toRadians(-80.0D), (float)Math.toRadians(-70.0D), 0.0F);
            this.walk(this.Right_Arm, speed_idle * 1.5F, degree_idle * 0.6F, false, 2.0F, 0.0F, f2, 1.0F);
            this.walk(this.Left_Arm, speed_idle * 1.5F, degree_idle * 0.6F, true, 2.0F, 0.0F, f2, 1.0F);
            this.flap(this.Right_Arm, speed_idle * 1.5F, degree_idle * 0.6F, false, 2.0F, 0.0F, f2, 1.0F);
            this.flap(this.Left_Arm, speed_idle * 1.5F, degree_idle * 0.6F, true, 2.0F, 0.0F, f2, 1.0F);
            if (entity.m_20096_()) {
               this.chainFlap(TAIL_NO_BASE, speed_idle, degree_idle * 0.5F, -1.0D, f2, 1.0F);
            }
         }
      } else {
