...
public class ModelFireDragonScaleArmor extends ArmorModelBase {
   ...
   public static MeshDefinition m_170681_(CubeDeformation deformation, float offset) {
      ...
      partdefinition.m_171597_("head").m_171597_("HeadFront").m_171599_("Teeth1", CubeListBuilder.m_171558_().m_171514_(6, 34).m_171481_(-3.6F, 0.1F, -8.9F, 4.0F, 1.0F, 5.0F), PartPose.m_171419_(0.0F, -1.0F, 0.0F));
