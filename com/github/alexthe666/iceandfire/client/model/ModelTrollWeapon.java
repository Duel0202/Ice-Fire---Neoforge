...
public class ModelTrollWeapon extends AdvancedEntityModel<Entity> {
   ...
   public ModelTrollWeapon() {
      ...
      this.setRotateAngle(this.log1, 3.1415927F, 0.0F, 0.0F);
      ...
      this.setRotateAngle(this.log2, -0.045553092F, 0.0F, 0.0F);
      ...
      this.setRotateAngle(this.blade2_2, 3.1415927F, 0.0F, 0.0F);
