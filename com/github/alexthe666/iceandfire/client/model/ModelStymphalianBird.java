...
public class ModelStymphalianBird extends ModelDragonBase<EntityStymphalianBird> {
   ...
   public ModelStymphalianBird() {
      ...
      this.setRotateAngle(this.WingL3, 0.12217305F, 0.17453292F, 0.091106184F);
      ...
      this.setRotateAngle(this.WingL2, 1.4835298F, 0.0F, -0.17453292F);
      ...
      this.setRotateAngle(this.WingR2, 1.4835298F, 0.0F, 0.17453292F);
      ...
      this.setRotateAngle(this.WingR, 0.08726646F, 0.0F, 0.17453292F);
      ...
      this.setRotateAngle(this.TailR1, 1.5707964F, 0.034906585F, 0.0F);
      ...
      this.setRotateAngle(this.ToeL1, -2.003289F, 3.1415927F, 0.0F);
      ...
      this.setRotateAngle(this.TailL2, 1.5707964F, 0.08726646F, -0.12217305F);
      ...
      this.setRotateAngle(this.ToeR1, -2.003289F, 3.1415927F, 0.0F);
      ...
      this.setRotateAngle(this.WingL, 0.08726646F, 0.0F, -0.17453292F);
      ...
      this.setRotateAngle(this.TailL1, 1.5707964F, -0.034906585F, 0.0F);
      ...
      this.setRotateAngle(this.WingR3, 0.12217305F, -0.17453292F, -0.08726646F);
      ...
      this.setRotateAngle(this.TailR2, 1.5707964F, -0.08726646F, 0.12217305F);
   ...
   public void setupAnim(EntityStymphalianBird entity, float f, float f1, float f2, float f3, float f4) {
      ...
      if (entity.flyProgress > 0.0F) {
         this.progressRotation(this.WingR, entity.flyProgress, 0.08726646F, 0.0F, 1.3962634F);
         this.progressRotation(this.WingR2, entity.flyProgress, -0.34906584F, 0.0F, 0.17453292F);
         this.progressRotation(this.WingR3, entity.flyProgress, 0.5235988F, 0.0F, 0.0F);
         this.progressRotation(this.WingL, entity.flyProgress, 0.08726646F, 0.0F, -1.3962634F);
         this.progressRotation(this.WingL2, entity.flyProgress, -0.34906584F, 0.0F, -0.17453292F);
         this.progressRotation(this.WingL3, entity.flyProgress, 0.5235988F, 0.0F, 0.0F);
         this.progressRotation(this.TailL1, entity.flyProgress, 1.5707964F, -0.034906585F, 0.0F);
         this.progressRotation(this.ToeR1, entity.flyProgress, -0.4098033F, 3.1415927F, 0.0F);
         this.progressRotation(this.TailR1, entity.flyProgress, 1.5707964F, 0.034906585F, 0.0F);
         ...
         this.progressRotation(this.FingerR2, entity.flyProgress, 0.15707964F, 0.0F, 0.0F);
         ...
         this.progressRotation(this.TailR2, entity.flyProgress, 1.5707964F, 0.34906584F, 0.12217305F);
         ...
         this.progressRotation(this.FingerL2, entity.flyProgress, 0.15707964F, 0.0F, 0.0F);
         ...
         this.progressRotation(this.FingerL3, entity.flyProgress, 0.2617994F, 0.0F, 0.0F);
         ...
         this.progressRotation(this.ToeL1, entity.flyProgress, -0.4098033F, 3.1415927F, 0.0F);
         this.progressRotation(this.TailL2, entity.flyProgress, 1.5707964F, -0.34906584F, -0.12217305F);
         this.progressRotation(this.Lowerbodytilt, entity.flyProgress, 1.7301449F, 0.0F, 0.0F);
         this.progressRotation(this.FingerR3, entity.flyProgress, 0.2617994F, 0.0F, 0.0F);
         ...
         this.chainFlap(WING_LEFT, speed_fly + (entity.getAnimation() == EntityStymphalianBird.ANIMATION_SHOOT_ARROWS ? 0.25F : 0.0F), -degree_fly * 0.5F, 0.0D, f2, 1.0F);
         this.chainFlap(WING_RIGHT, speed_fly + (entity.getAnimation() == EntityStymphalianBird.ANIMATION_SHOOT_ARROWS ? 0.25F : 0.0F), degree_fly * 0.5F, 0.0D, f2, 1.0F);
         if (entity.getAnimation() != EntityStymphalianBird.ANIMATION_SHOOT_ARROWS) {
            this.chainWave(NECK, speed_fly, degree_fly * 0.15F, 4.0D, f2, 1.0F);
         ...
         this.chainWave(NECK, speed_idle, degree_idle * 0.15F, 4.0D, f2, 1.0F);
         this.chainWave(FEATHERS, speed_idle, degree_idle * -0.1F, 0.0D, f2, 1.0F);
         ...
         this.chainWave(NECK, speed_walk, degree_walk * 0.5F, -3.0D, f, f1);
         this.chainWave(FEATHERS, speed_walk, degree_walk * -0.1F, 0.0D, f, f1);
