...
public enum EnumDragonPoses implements IEnumDragonPoses {
   ...
   private EnumDragonPoses(String pose) {
      this.pose = pose;
   }
   ...
   // $FF: synthetic method
   private static EnumDragonPoses[] $values() {
      return new EnumDragonPoses[]{MALE, FEMALE, FLYING_POSE, DIVING_POSE, GROUND_POSE, HOVERING_POSE, SITTING_POSE, SLEEPING_POSE, SWIM_POSE, SWIM1, SWIM2, SWIM3, SWIM4, SWIM5, BITE1, BITE2, BITE3, BLAST_BREATH, BLAST_CHARGE1, BLAST_CHARGE2, BLAST_CHARGE3, STREAM_BREATH, STREAM_CHARGE1, STREAM_CHARGE2, STREAM_CHARGE3, DEAD, GRAB1, GRAB2, GRAB_SHAKE1, GRAB_SHAKE2, GRAB_SHAKE3, ROAR1, ROAR2, ROAR3, EPIC_ROAR1, EPIC_ROAR2, EPIC_ROAR3, TAIL_WHIP1, TAIL_WHIP2, TAIL_WHIP3, WING_BLAST1, WING_BLAST2, WING_BLAST3, WING_BLAST4, WING_BLAST5, WING_BLAST6, WING_BLAST7, WALK1, WALK2, WALK3, WALK4, FLIGHT1, FLIGHT2, FLIGHT3, FLIGHT4, FLIGHT5, FLIGHT6, TACKLE, SIT_ON_PLAYER_POSE};
   }
}
