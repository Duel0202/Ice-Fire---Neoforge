...
public class ModelCockatriceChick extends ModelDragonBase<EntityCockatrice> {
   ...
   public ModelCockatriceChick() {
      ...
      this.setRotateAngle(this.rightLeg, 1.3089969F, -0.0F, 0.0F);
      ...
      this.setRotateAngle(this.leftFoot, -1.3089969F, -0.0F, 0.0F);
      ...
      this.setRotateAngle(this.rightFoot, -1.3089969F, -0.0F, 0.0F);
      ...
      this.setRotateAngle(this.leftLeg, 1.3089969F, -0.0F, 0.0F);
   ...
   public void setupAnim(EntityCockatrice entity, float f, float f1, float f2, float f3, float f4) {
      ...
      this.chainWave(NECK, speed_idle, degree_idle * 0.1F, 4.0D, f2, 1.0F);
      this.chainSwing(TAIL, speed_idle, degree_idle * 0.5F, 0.0D, f2, 1.0F);
      ...
      this.chainWave(NECK, speed_walk, degree_walk * 0.5F, 4.0D, f, f1);
      ...
      this.progressRotation(this.neck, entity.stareProgress, (float)Math.toRadians(10.0D), 0.0F, 0.0F);
      this.progressRotation(this.neck2, entity.stareProgress, (float)Math.toRadians(-18.0D), 0.0F, 0.0F);
      this.progressRotation(this.head, entity.stareProgress, (float)Math.toRadians(18.0D), 0.0F, 0.0F);
      this.progressRotation(this.rightThigh, entity.sitProgress, (float)Math.toRadians(-15.0D), 0.0F, 0.0F);
      this.progressRotation(this.leftThigh, entity.sitProgress, (float)Math.toRadians(-15.0D), 0.0F, 0.0F);
      this.progressRotation(this.rightLeg, entity.sitProgress, (float)Math.toRadians(13.0D), 0.0F, 0.0F);
      this.progressRotation(this.leftLeg, entity.sitProgress, (float)Math.toRadians(13.0D), 0.0F, 0.0F);
