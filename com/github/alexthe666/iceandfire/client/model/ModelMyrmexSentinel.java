...
public class ModelMyrmexSentinel extends ModelMyrmexBase {
   ...
   public void m_6973_(Entity entity, float f, float f1, float f2, float f3, float f4) {
      ...
      this.progressRotation(this.legTopR1, myrmex.holdingProgress, (float)Math.toRadians(35.0D), (float)Math.toRadians(30.0D), (float)Math.toRadians(10.0D));
      this.progressRotation(this.legTopR1_1, myrmex.holdingProgress, (float)Math.toRadians(35.0D), (float)Math.toRadians(-30.0D), (float)Math.toRadians(-10.0D));
      this.progressRotation(this.legMidR1, myrmex.holdingProgress, (float)Math.toRadians(-133.0D), 0.0F, 0.0F);
      this.progressRotation(this.legMidR1_1, myrmex.holdingProgress, (float)Math.toRadians(-133.0D), 0.0F, 0.0F);
      this.progressRotation(this.legBottomR1, myrmex.holdingProgress, (float)Math.toRadians(140.0D), (float)Math.toRadians(20.0D), 0.0F);
      this.progressRotation(this.legBottomR1_1, myrmex.holdingProgress, (float)Math.toRadians(140.0D), (float)Math.toRadians(-20.0D), 0.0F);
      this.progressRotation(this.legTopR1, myrmex.hidingProgress, (float)Math.toRadians(70.0D), 0.0F, (float)Math.toRadians(70.0D));
      this.progressRotation(this.legTopR1_1, myrmex.hidingProgress, (float)Math.toRadians(70.0D), 0.0F, (float)Math.toRadians(-70.0D));
      this.progressRotation(this.Body1, myrmex.hidingProgress, (float)Math.toRadians(-2.0D), 0.0F, 0.0F);
      ...
      this.progressRotation(this.Body2, myrmex.hidingProgress, (float)Math.toRadians(5.0D), 0.0F, 0.0F);
      this.progressRotation(this.legTopR2, myrmex.hidingProgress, (float)Math.toRadians(55.0D), (float)Math.toRadians(30.0D), (float)Math.toRadians(-7.0D));
      this.progressRotation(this.legTopR2_1, myrmex.hidingProgress, (float)Math.toRadians(55.0D), (float)Math.toRadians(-30.0D), (float)Math.toRadians(7.0D));
      this.progressRotation(this.legTopR3, myrmex.hidingProgress, (float)Math.toRadians(45.0D), (float)Math.toRadians(10.0D), (float)Math.toRadians(40.0D));
      this.progressRotation(this.legTopR3_1, myrmex.hidingProgress, (float)Math.toRadians(45.0D), (float)Math.toRadians(-10.0D), (float)Math.toRadians(-40.0D));
      this.progressRotation(this.legMidR2, myrmex.hidingProgress, 0.0F, 0.0F, (float)Math.toRadians(-140.0D));
      this.progressRotation(this.legMidR2_1, myrmex.hidingProgress, 0.0F, 0.0F, (float)Math.toRadians(140.0D));
      this.progressRotation(this.legMidR3, myrmex.hidingProgress, 0.0F, 0.0F, (float)Math.toRadians(146.0D));
      this.progressRotation(this.legMidR3_1, myrmex.hidingProgress, 0.0F, 0.0F, (float)Math.toRadians(-146.0D));
      this.progressRotation(this.legBottomR2, myrmex.hidingProgress, 0.0F, 0.0F, (float)Math.toRadians(146.0D));
      this.progressRotation(this.legBottomR2_1, myrmex.hidingProgress, 0.0F, 0.0F, (float)Math.toRadians(-146.0D));
      this.progressRotation(this.legBottomR3, myrmex.hidingProgress, 0.0F, 0.0F, (float)Math.toRadians(-156.0D));
      this.progressRotation(this.legBottomR3_1, myrmex.hidingProgress, 0.0F, 0.0F, (float)Math.toRadians(156.0D));
      this.progressRotation(this.HeadBase, myrmex.hidingProgress, (float)Math.toRadians(-15.0D), 0.0F, 0.0F);
      this.progressPosition(this.HeadBase, myrmex.hidingProgress, 0.0F, 0.0F, -4.4F);
      this.progressRotation(this.Tail1, myrmex.hidingProgress, (float)Math.toRadians(-20.0D), 0.0F, (float)Math.toRadians(-46.0D));
      this.progressRotation(this.Tail2, myrmex.hidingProgress, (float)Math.toRadians(26.0D), 0.0F, 0.0F);
      this.progressRotation(this.Tail3, myrmex.hidingProgress, (float)Math.toRadians(40.0D), 0.0F, (float)Math.toRadians(-30.0D));
      this.progressRotation(this.Tail4, myrmex.hidingProgress, (float)Math.toRadians(25.0D), 0.0F, (float)Math.toRadians(-18.0D));
      this.progressRotation(this.Tail5, myrmex.hidingProgress, (float)Math.toRadians(23.0D), 0.0F, 0.0F);
      this.progressRotation(this.Tail6, myrmex.hidingProgress, (float)Math.toRadians(10.0D), (float)Math.toRadians(-15.0D), (float)Math.toRadians(33.0D));
      this.progressRotation(this.Tail7, myrmex.hidingProgress, (float)Math.toRadians(23.0D), 0.0F, 0.0F);
      this.progressRotation(this.Tail8, myrmex.hidingProgress, (float)Math.toRadians(-20.0D), (float)Math.toRadians(-45.0D), (float)Math.toRadians(85.0D));
   }
