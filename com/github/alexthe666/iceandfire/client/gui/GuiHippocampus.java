...
public class GuiHippocampus extends AbstractContainerScreen<HippocampusContainerMenu> {
   ...
   protected void m_280003_(GuiGraphics pGuiGraphics, int mouseX, int mouseY) {
      ...
      if (entity instanceof EntityHippocampus) {
         ...
         pGuiGraphics.m_280056_(font, hippo.m_5446_().getString(), l + 8, 6, 4210752, false);
      }

      pGuiGraphics.m_280614_(font, this.f_169604_, k + 8, l + this.f_97727_ - 96 + 2, 4210752, false);
   }
