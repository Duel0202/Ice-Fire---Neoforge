...
public class RenderDragonBase extends MobRenderer<EntityDragonBase, AdvancedEntityModel<EntityDragonBase>> {
   ...
   public RenderDragonBase(Context context, AdvancedEntityModel<EntityDragonBase> model, int dragonType) {
   ...
   protected void scale(EntityDragonBase entity, PoseStack matrixStackIn, float partialTickTime) {
      ...
      matrixStackIn.m_85841_(this.f_114477_, this.f_114477_, this.f_114477_);
   }

   @NotNull
   public ResourceLocation getTextureLocation(EntityDragonBase entity) {
      String var10000 = entity.getVariantName(entity.getVariant());
      String baseTexture = var10000 + entity.getDragonStage() + entity.isModelDead() + entity.isMale() + entity.isSkeletal() + entity.m_5803_() + entity.isBlinking();
