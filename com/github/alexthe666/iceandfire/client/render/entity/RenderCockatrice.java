...
public class RenderCockatrice extends MobRenderer<EntityCockatrice, AdvancedEntityModel<EntityCockatrice>> {
   ...
   public RenderCockatrice(Context context) {
      ...
      if (super.m_5523_(livingEntityIn, camera, camX, camY, camZ)) {
         ...
         if (livingEntityIn.hasTargetedEntity()) {
            ...
            if (livingentity != null) {
               Vec3 Vector3d = this.getPosition(livingentity, (double)livingentity.m_20206_() * 0.5D, 1.0F);
   ...
   public void render(EntityCockatrice entityIn, float entityYaw, float partialTicks, @NotNull PoseStack matrixStackIn, @NotNull MultiBufferSource bufferIn, int packedLightIn) {
      ...
      boolean blindness = entityIn.m_21023_(MobEffects.f_19610_) || livingentity != null && livingentity.m_21023_(MobEffects.f_19610_);
      if (!blindness && livingentity != null && EntityGorgon.isEntityLookingAt(entityIn, livingentity, 0.6000000238418579D) && EntityGorgon.isEntityLookingAt(livingentity, entityIn, 0.6000000238418579D) && livingentity != null) {
