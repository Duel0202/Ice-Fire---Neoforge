...
public class LayerBipedArmorMultiple<R extends MobRenderer & IHasArmorVariantResource, T extends LivingEntity & IHasArmorVariant & IAnimatedEntity, M extends ModelBipedBase<T>, A extends ModelBipedBase<T>> extends LayerBipedArmor<T, M, A> {
   ...
   public LayerBipedArmorMultiple(R mobRenderer, A modelLeggings, A modelArmor, ResourceLocation defaultArmor, ResourceLocation defaultLegArmor) {
   ...
   public ResourceLocation getArmorResource(T entity, ItemStack stack, EquipmentSlot slot, @Nullable String type) {
      return ((IHasArmorVariantResource)this.mobRenderer).getArmorResource(((IHasArmorVariant)entity).getBodyArmorVariant(), slot);
   }
}
