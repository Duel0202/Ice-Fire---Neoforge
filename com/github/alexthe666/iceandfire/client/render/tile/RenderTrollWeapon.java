...
public class RenderTrollWeapon extends BlockEntityWithoutLevelRenderer {
   ...
   public void m_108829_(ItemStack stack, @NotNull ItemDisplayContext type, @NotNull PoseStack stackIn, @NotNull MultiBufferSource bufferIn, int combinedLightIn, int combinedOverlayIn) {
      ...
      if (stack.m_41720_() instanceof ItemTrollWeapon) {
         weapon = ((ItemTrollWeapon)stack.m_41720_()).weapon;
      }

      stackIn.m_85836_();
      stackIn.m_252880_(0.5F, -0.75F, 0.5F);
      MODEL.m_7695_(stackIn, bufferIn.m_6299_(RenderType.m_110452_(weapon.TEXTURE)), combinedLightIn, combinedOverlayIn, 1.0F, 1.0F, 1.0F, 1.0F);
      stackIn.m_85849_();
   }
}
