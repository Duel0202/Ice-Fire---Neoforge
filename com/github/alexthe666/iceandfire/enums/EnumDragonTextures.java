...
public enum EnumDragonTextures {
   ...
   private EnumDragonTextures(String fireVariant, String iceVariant, String lightningVariant) {
      ...
      String var10003 = fireVariant.substring(0, fireVariant.length() - 1);
      this.FIRE_MALE_OVERLAY = new ResourceLocation("iceandfire:textures/models/firedragon/male_" + var10003 + ".png");
      var10003 = iceVariant.substring(0, iceVariant.length() - 1);
      this.ICE_MALE_OVERLAY = new ResourceLocation("iceandfire:textures/models/icedragon/male_" + var10003 + ".png");
      ...
      var10003 = lightningVariant.substring(0, lightningVariant.length() - 1);
      this.LIGHTNING_MALE_OVERLAY = new ResourceLocation("iceandfire:textures/models/lightningdragon/male_" + var10003 + ".png");
   }
   ...
   private static ResourceLocation getFireDragonTextures(EntityDragonBase dragon) {
      ...
      } else if (!dragon.m_5803_() && !dragon.isBlinking()) {
         switch(dragon.getDragonStage()) {
         case 1:
   ...
   // $FF: synthetic method
   private static EnumDragonTextures[] $values() {
      return new EnumDragonTextures[]{VARIANT1, VARIANT2, VARIANT3, VARIANT4};
   }
   ...
   public static enum Armor {
      ...
      public static EnumDragonTextures.Armor getArmorForDragon(EntityDragonBase dragon, EquipmentSlot slot) {
         int armor = dragon.getArmorOrdinal(dragon.m_6844_(slot));
         switch(slot) {
         case CHEST:
            switch(armor) {
            case 1:
      ...
      // $FF: synthetic method
      private static EnumDragonTextures.Armor[] $values() {
         return new EnumDragonTextures.Armor[]{EMPTY, ARMORBODY1, ARMORBODY2, ARMORBODY3, ARMORBODY4, ARMORBODY5, ARMORBODY6, ARMORBODY7, ARMORBODY8, ARMORHEAD1, ARMORHEAD2, ARMORHEAD3, ARMORHEAD4, ARMORHEAD5, ARMORHEAD6, ARMORHEAD7, ARMORHEAD8, ARMORNECK1, ARMORNECK2, ARMORNECK3, ARMORNECK4, ARMORNECK5, ARMORNECK6, ARMORNECK7, ARMORNECK8, ARMORTAIL1, ARMORTAIL2, ARMORTAIL3, ARMORTAIL4, ARMORTAIL5, ARMORTAIL6, ARMORTAIL7, ARMORTAIL8};
      }
   }
}
