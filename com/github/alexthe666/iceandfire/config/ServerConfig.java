...
public class ServerConfig {
   public final BooleanValue generateDragonSkeletons;
   public final IntValue generateDragonSkeletonChance;
   public final IntValue generateDragonDenChance;
   public final IntValue generateDragonRoostChance;
   public final IntValue dragonDenGoldAmount;
   public final BooleanValue spawnGlaciers;
   public final IntValue glacierSpawnChance;
   public final IntValue oreToStoneRatioForDragonCaves;
   public final IntValue dragonEggTime;
   public final IntValue dragonGriefing;
   public final BooleanValue tamedDragonGriefing;
   public final IntValue dragonFlapNoiseDistance;
   public final IntValue dragonFluteDistance;
   public final DoubleValue dragonHealth;
   public final IntValue dragonAttackDamage;
   public final DoubleValue dragonAttackDamageFire;
   public final DoubleValue dragonAttackDamageIce;
   public final DoubleValue dragonAttackDamageLightning;
   public final IntValue maxDragonFlight;
   public final IntValue dragonGoldSearchLength;
   public final BooleanValue canDragonsHealFromBiting;
   public final BooleanValue canDragonsDespawn;
   public final BooleanValue doDragonsSleep;
   public final BooleanValue dragonDigWhenStuck;
   public final IntValue dragonBreakBlockCooldown;
   public final BooleanValue dragonDropSkull;
   public final BooleanValue dragonDropHeart;
   public final BooleanValue dragonDropBlood;
   public final IntValue dragonTargetSearchLength;
   public final IntValue dragonWanderFromHomeDistance;
   public final IntValue dragonHungerTickRate;
   public final BooleanValue spawnHippogryphs;
   public final IntValue hippogryphSpawnRate;
   public final BooleanValue generateGorgonTemple;
   public final DoubleValue gorgonMaxHealth;
   public final IntValue spawnPixiesChance;
   public final IntValue pixieVillageSize;
   public final BooleanValue pixiesStealItems;
   public final IntValue spawnWanderingCyclopsChance;
   public final IntValue spawnCyclopsCaveChance;
   public final IntValue cyclopesSheepSearchLength;
   public final DoubleValue cyclopsMaxHealth;
   public final DoubleValue cyclopsAttackStrength;
   public final DoubleValue cyclopsBiteStrength;
   public final BooleanValue cyclopsGriefing;
   public final DoubleValue sirenMaxHealth;
   public final BooleanValue sirenShader;
   public final IntValue sirenMaxSingTime;
   public final IntValue sirenTimeBetweenSongs;
   public final IntValue generateSirenChance;
   public final IntValue hippocampusSpawnChance;
   public final IntValue deathWormTargetSearchLength;
   public final DoubleValue deathWormMaxHealth;
   public final DoubleValue deathWormAttackStrength;
   public final BooleanValue deathWormAttackMonsters;
   public final IntValue deathWormSpawnRate;
   public final IntValue cockatriceChickenSearchLength;
   public final IntValue cockatriceEggChance;
   public final DoubleValue cockatriceMaxHealth;
   public final BooleanValue chickensLayRottenEggs;
   public final BooleanValue spawnCockatrices;
   public final IntValue cockatriceSpawnRate;
   public final IntValue stymphalianBirdTargetSearchLength;
   public final IntValue stymphalianBirdFeatherDropChance;
   public final DoubleValue stymphalianBirdFeatherAttackStength;
   public final IntValue stymphalianBirdFlockLength;
   public final IntValue stymphalianBirdFlightHeight;
   public final BooleanValue stymphalianBirdsDataTagDrops;
   public final BooleanValue stympahlianBirdAttackAnimals;
   public final IntValue stymphalianBirdSpawnChance;
   public final BooleanValue spawnTrolls;
   public final IntValue trollSpawnRate;
   public final BooleanValue trollsDropWeapon;
   public final DoubleValue trollMaxHealth;
   public final DoubleValue trollAttackStrength;
   public final BooleanValue villagersFearDragons;
   public final BooleanValue animalsFearDragons;
   public final IntValue myrmexPregnantTicks;
   public final IntValue myrmexEggTicks;
   public final IntValue myrmexLarvaTicks;
   public final IntValue myrmexColonyGenChance;
   public final IntValue myrmexColonySize;
   public final DoubleValue myrmexBaseAttackStrength;
   public final IntValue myrmexMaximumWanderRadius;
   public final BooleanValue myrmexHiveIgnoreDaytime;
   public final BooleanValue spawnAmphitheres;
   public final IntValue amphithereSpawnRate;
   public final IntValue amphithereVillagerSearchLength;
   public final IntValue amphithereTameTime;
   public final DoubleValue amphithereFlightSpeed;
   public final DoubleValue amphithereMaxHealth;
   public final DoubleValue amphithereAttackStrength;
   public final IntValue seaSerpentSpawnChance;
   public final BooleanValue seaSerpentGriefing;
   public final DoubleValue seaSerpentBaseHealth;
   public final DoubleValue seaSerpentAttackStrength;
   public final DoubleValue dragonsteelBaseDamage;
   public final IntValue dragonsteelBaseArmor;
   public final DoubleValue dragonsteelBaseArmorToughness;
   public final IntValue dragonsteelBaseDurability;
   public final IntValue dragonsteelBaseDurabilityEquipment;
   public final BooleanValue dragonMovedWronglyFix;
   public final BooleanValue weezerTinkers;
   public final DoubleValue dragonBlockBreakingDropChance;
   public final BooleanValue completeDragonPathfinding;
   public final BooleanValue generateMausoleums;
   public final BooleanValue spawnLiches;
   public final IntValue lichSpawnRate;
   public final IntValue lichSpawnChance;
   public final DoubleValue hydraMaxHealth;
   public final IntValue generateHydraChance;
   public final BooleanValue explosiveDragonBreath;
   public final DoubleValue weezerTinkersDisarmChance;
   public final BooleanValue chunkLoadSummonCrystal;
   public IntValue dangerousWorldGenDistanceLimit;
   public IntValue dangerousWorldGenSeparationLimit;
   public final DoubleValue dragonFlightSpeedMod;
   public final DoubleValue hippogryphFlightSpeedMod;
   public final DoubleValue hippocampusSwimSpeedMod;
   public final DoubleValue ghostMaxHealth;
   public final DoubleValue ghostAttackStrength;
   public final BooleanValue generateGraveyards;
   public final BooleanValue ghostSpawnFromPlayerDeaths;
   public IntValue dragonPathfindingThreads;
   public IntValue maxDragonPathingNodes;
   public BooleanValue pathfindingDebug;
   public final BooleanValue dragonWeaponFireAbility;
   public final BooleanValue dragonWeaponIceAbility;
   public final BooleanValue dragonWeaponLightningAbility;
   public IntValue villagerHouseWeight;
   public BooleanValue allowAttributeOverriding;
   ...
   public ServerConfig(Builder builder) {
      ...
      this.dragonBlockBreakingDropChance = buildDouble(builder, "Dragon Block Breaking Drop Chance", "all", 0.10000000149011612D, 0.0D, 1.0D, "The percentage chance for a block to drop as an item when a dragon breaks it.");
      builder.pop();
      ...
      this.dragonHealth = buildDouble(builder, "Dragon Health", "all", 500.0D, 1.0D, 100000.0D, "Max dragon health. Health is scaled to this");
      ...
      this.dragonAttackDamageFire = buildDouble(builder, "Dragon Attack Damage(Fire breath)", "all", 2.0D, 0.0D, 10000.0D, "Damage dealt from a successful fire breath attack. Attack Damage is scaled to by age, so a stage 5 dragon will deal 5x as much as this number");
      this.dragonAttackDamageIce = buildDouble(builder, "Dragon Attack Damage(Ice breath)", "all", 2.5D, 0.0D, 10000.0D, "Damage dealt from a successful ice breath attack. Attack Damage is scaled to by age, so a stage 5 dragon will deal 5x as much as this number");
      this.dragonAttackDamageLightning = buildDouble(builder, "Dragon Attack Damage(Lightning breath)", "all", 3.5D, 0.0D, 10000.0D, "Damage dealt from a successful lightning breath attack. Attack Damage is scaled to by age, so a stage 5 dragon will deal 5x as much as this number");
      this.dragonFlightSpeedMod = buildDouble(builder, "Dragon Flight Speed Modifier", "all", 1.0D, 0.0D, 2.0D, "Change this to slow down or speed up dragon or amphithere flight.");
      ...
      this.cyclopsMaxHealth = buildDouble(builder, "Cyclops Max Health", "all", 150.0D, 1.0D, 10000.0D, "Maximum cyclops health");
      ...
      this.cyclopsAttackStrength = buildDouble(builder, "Cyclops Attack Strength", "all", 15.0D, 1.0D, 10000.0D, "Cyclops attack strength");
      this.cyclopsBiteStrength = buildDouble(builder, "Cyclops Bite Strength", "all", 40.0D, 1.0D, 10000.0D, "Amount of damage done with cyclops bite attack.");
      ...
      builder.pop();
      builder.push("Sirens");
      this.sirenMaxHealth = buildDouble(builder, "Siren Max Health", "all", 50.0D, 1.0D, 10000.0D, "Maximum siren health");
      ...
      this.deathWormMaxHealth = buildDouble(builder, "Death Worm Base Health", "all", 10.0D, 1.0D, 10000.0D, "Default deathworm health, this is scaled to the worm's particular size");
      this.deathWormAttackStrength = buildDouble(builder, "Death Worm Base Attack Strength", "all", 3.0D, 1.0D, 10000.0D, "Default deathworm attack strength, this is scaled to the worm's particular size");
      ...
      this.cockatriceMaxHealth = buildDouble(builder, "Cockatrice Health", "all", 40.0D, 1.0D, 10000.0D, "Maximum cockatrice health");
      ...
      this.stymphalianBirdFeatherAttackStength = buildDouble(builder, "Stymphalian Bird Feather Attack Strength", "all", 1.0D, 0.0D, 10000.0D, "Stymphalian bird feather attack strength.");
      ...
      this.trollMaxHealth = buildDouble(builder, "Troll Max Health", "all", 50.0D, 1.0D, 10000.0D, "Maximum troll health");
      this.trollAttackStrength = buildDouble(builder, "Troll Attack Strength", "all", 10.0D, 1.0D, 10000.0D, "Troll attack strength");
      builder.pop();
      builder.push("Myrmex");
      ...
      this.myrmexBaseAttackStrength = buildDouble(builder, "Myrmex Base Attack Strength", "all", 3.0D, 1.0D, 10000.0D, "Base Myrmex(worker) attack strength");
      ...
      this.amphithereFlightSpeed = buildDouble(builder, "Amphithere Flight Speed", "all", 1.75D, 0.0D, 3.0D, "How fast amphitheres fly.");
      this.amphithereMaxHealth = buildDouble(builder, "Amphithere Max Health", "all", 50.0D, 1.0D, 10000.0D, "Maximum amphithere health");
      this.amphithereAttackStrength = buildDouble(builder, "Amphithere Attack Strength", "all", 7.0D, 1.0D, 10000.0D, "Amphithere attack strength");
      builder.pop();
      ...
      this.seaSerpentBaseHealth = buildDouble(builder, "Sea Serpent Base Health", "all", 20.0D, 1.0D, 10000.0D, "Default sea serpent health, this is scaled to the sea serpent's particular size");
      this.seaSerpentAttackStrength = buildDouble(builder, "Sea Serpent Base Attack Strength", "all", 4.0D, 1.0D, 10000.0D, "Default sea serpent attack strength, this is scaled to the sea serpent's particular size");
      builder.pop();
      ...
      this.hippocampusSwimSpeedMod = buildDouble(builder, "Hippocampus Swim Speed Modifier", "all", 1.0D, 0.0D, 2.0D, "Change this to slow down or speed up hippocampus swimming.");
      builder.pop();
      ...
      this.hippogryphFlightSpeedMod = buildDouble(builder, "Hippogryph Flight Speed Modifier", "all", 1.0D, 0.0D, 2.0D, "Change this to slow down or speed up hippogryph flight.");
      builder.pop();
      builder.push("Gorgons");
      this.gorgonMaxHealth = buildDouble(builder, "Gorgon Max Health", "all", 100.0D, 1.0D, 10000.0D, "Maximum gorgon health");
      builder.pop();
      builder.push("Others");
      ...
      this.hydraMaxHealth = buildDouble(builder, "Hydra Max Health", "all", 250.0D, 1.0D, 10000.0D, "Maximum hydra health");
      ...
      this.ghostMaxHealth = buildDouble(builder, "Ghost Max Health", "all", 30.0D, 1.0D, 10000.0D, "Maximum ghost health.");
      this.ghostAttackStrength = buildDouble(builder, "Ghost Attack Strength", "all", 3.0D, 0.0D, 10000.0D, "Maximum ghost attack strength.");
      ...
      builder.pop();
      builder.push("Items");
      this.dragonsteelBaseDamage = buildDouble(builder, "Dragonsteel Sword Base Attack Strength", "all", 25.0D, 5.0D, 2.147483647E9D, "Default attack strength of a dragonsteel sword.");
      ...
      this.dragonsteelBaseArmorToughness = buildDouble(builder, "Dragonsteel Base Armor Toughness", "all", 6.0D, 0.0D, Double.MAX_VALUE, "Default armor toughness value of dragonsteel.");
      ...
      this.weezerTinkersDisarmChance = buildDouble(builder, "Easter Egg Tinkers Tool Disarm chance", "all", 0.20000000298023224D, 0.0D, 1.0D, "Percentage of critical strike that will disarm with easter egg tinkers material.");
